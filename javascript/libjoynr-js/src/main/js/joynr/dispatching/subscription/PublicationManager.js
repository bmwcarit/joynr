...
class PublicationManager {
     ...
     *
     * @param {String} joynrInstanceId: the Id of the actual joynr instance
     */
    constructor(dispatcher, persistency, joynrInstanceId) {
         ...
         * @private
         *
         * @param {String} participantId the participantId of the provider
         ...
         * @private
         *
         * @param {Object} subscriptionInfo the subscription information
         * @param {String} subscriptionInfo.providerParticipantId the participantId of the provider
         * @param {String} subscriptionInfo.subscribedToName the attribute to be published
         ...
         * @param {String} subscriptionInfo.providerParticipantId the participantId of the provider
         * @param {String} subscriptionInfo.subscribedToName the attribute to be published
         * @param {Number} delay the delay to wait for the publication
         */
         ...
         * @param {String} providerId
         * @param {String} attributeName
         * @param {ProviderAttribute} attribute
         * @param {?} value
         */
                ...
                if (subscriptions.hasOwnProperty(subscriptionId)) {
                    ...
                    if (filters && filters.length > 0) {
                        for (i = 0; i < filters.length; i++) {
                            if (
                                subscriptionInfo.filterParameters &&
         ...
         * @param {Boolean} silent suppress log outputs if subscription cannot be found
         */
        function removeSubscription(subscriptionId, silent) {
            ...
            if (subscriptionInfo.subscriptionType === SubscriptionInformation.SUBSCRIPTION_TYPE_ATTRIBUTE) {
                ...
                const attributeSubscriptions = getSubscriptionsForProviderAttribute(
         ...
         * @function
         *
         * @param {SubscriptionStop} subscriptionStop incoming subscriptionStop
         */
         ...
         * @function
         *
         * @param {SubscriptionRequest} proxyParticipantId - participantId of proxy consuming the attribute publications
        ...
        this.handleSubscriptionRequest = function handleSubscriptionRequest(
            ...
            if (provider === undefined) {
                ...
                if (pendingSubscriptions === undefined) {
                    pendingSubscriptions = [];
                    queuedProviderParticipantIdToSubscriptionRequestsMapping[
                        providerParticipantId
                    ] = pendingSubscriptions;
                }
         ...
         * @function
         *
         * @param {BroadcastSubscriptionRequest} proxyParticipantId - participantId of proxy consuming the broadcast
         ...
         * @function
         *
         * @param {MulticastSubscriptionRequest} providerParticipantId - participantId of provider producing the multicast
         *            subscriptionRequest incoming subscriptionRequest
         *            callbackDispatcher callback function to inform the caller about the handling result
         * @throws {Error} when no provider exists or the provider does not have the event
         */
         ...
         * @function
         *
         * @param {String} participantId of the provider handling the subsription
         */
            ...
            if (pendingSubscriptions !== undefined) {
                for (pendingSubscription in pendingSubscriptions) {
                    if (pendingSubscriptions.hasOwnProperty(pendingSubscription)) {
                        ...
                        if (
                            subscriptionObject.subscriptionType === SubscriptionInformation.SUBSCRIPTION_TYPE_ATTRIBUTE
                        ) {
        ...
        this.hasSubscriptions = function() {
            ...
            const hasOnChangeProviderEventToSubscriptions =
                Object.keys(onChangeProviderEventToSubscriptions).length > 0;
