...
//#######################################################
// #####################################################
#ifndef GENERATED_TYPE_JOYNR_TESTS_INTERFACEVERSIONEDSTRUCT_H
#define GENERATED_TYPE_JOYNR_TESTS_INTERFACEVERSIONEDSTRUCT_H
...
/**
 * @brief Function object that implements a hash function for joynr::tests::InterfaceVersionedStruct.
 *
 ...
 */
template<>
struct hash<joynr::tests::InterfaceVersionedStruct> {
	 ...
	 */
	std::size_t operator()(const joynr::tests::InterfaceVersionedStruct& interfaceVersionedStructValue) const {
		return joynr::tests::hash_value(interfaceVersionedStructValue);
	}
};
} // namespace std

MUESLI_REGISTER_TYPE(joynr::tests::InterfaceVersionedStruct, "joynr.tests.InterfaceVersionedStruct")

#endif // GENERATED_TYPE_JOYNR_TESTS_INTERFACEVERSIONEDSTRUCT_H
