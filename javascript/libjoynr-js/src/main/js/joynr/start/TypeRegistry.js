...
class TypeRegistry {
    ...
    constructor() {
         ...
         * @function
         *
         * @param {String} joynrTypeName - the joynr type name that is sent on the wire.
         * @param {Function} typeConstructor - the corresponding JavaScript constructor for this type.
         * @param {boolean} isEnum - optional flag if the added type is an enumeration type
         */
         ...
         * @function
         *
         * @param {String} joynrTypeName - the joynr type name that is sent/received on the wire.
         ...
         * @function
         *
         * @param {String} joynrTypeName - the joynr type name that is to be resolved
         * @param {Number} timeout - if timeout exceed before required joynr type is registered,
