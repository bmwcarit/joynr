...
public class JoynrTimeoutExceptionDeserializer extends StdDeserializer<JoynrTimeoutException> {
    private static final long serialVersionUID = 1L;
    private static final String JSON_FIELD_NAME_EXPIRY_DATE = "expiryDate";

    private static Class<? extends JoynrRuntimeException> targetType = JoynrTimeoutException.class;
    ...
    public JoynrTimeoutExceptionDeserializer() {
        super(JoynrTimeoutException.class);
    }

    @Override
    public JoynrTimeoutException deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException,
                                                                                         JacksonException {
        String message = null;
        ...
        return new JoynrTimeoutException(message, expiryDate.longValue(), this);
    }
