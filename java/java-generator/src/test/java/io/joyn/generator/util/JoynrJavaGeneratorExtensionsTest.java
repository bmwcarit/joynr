...
public class JoynrJavaGeneratorExtensionsTest {
    ...
    private static final String SECOND_LEVEL_STRUCT_TYPE_NAME = "joynr.io.joyn.generator.util.SecondLevelStruct";
    private static final String TOP_LEVEL_STRUCT_INCLUDE = "joynr.io.joyn.generator.util.TopLevelStruct";
