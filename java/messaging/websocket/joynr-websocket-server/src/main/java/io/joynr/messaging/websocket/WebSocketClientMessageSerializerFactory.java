...
public class WebSocketClientMessageSerializerFactory extends
        AbstractMiddlewareMessageSerializerFactory<WebSocketClientAddress> {
    ...
    @Override
    protected JoynrMessageSerializer createInternal(WebSocketClientAddress address) {
