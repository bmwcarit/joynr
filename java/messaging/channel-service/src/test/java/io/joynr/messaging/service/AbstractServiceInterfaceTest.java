...
/**
 * Abstract class to set up a Jetty server for unit tests to test the service
 * interfaces.
 * 
...
public abstract class AbstractServiceInterfaceTest {
    ...
    protected ChannelInformation createChannelInfo(String bpId, String bpBaseUrl, String channelId) {
