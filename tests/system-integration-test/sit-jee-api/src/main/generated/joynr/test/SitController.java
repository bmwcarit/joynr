...
@ProvidesJoynrTypesInfo(interfaceClass = SitController.class, interfaceName = "test/SitController")
@SuppressWarnings("unused")
public interface SitController {
	public static String INTERFACE_NAME = "test/SitController";
