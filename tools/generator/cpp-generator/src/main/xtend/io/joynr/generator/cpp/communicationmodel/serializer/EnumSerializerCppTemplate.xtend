...
class EnumSerializerCppTemplate extends EnumTemplate {
...
template <>
void PrimitiveDeserializer<«typeName»>::deserialize(«typeName»& «joynrName.toFirstLower», const IValue& value)
{
