...
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_IMULTIPLEVERSIONSINTERFACE2CONNECTOR_H
#define GENERATED_INTERFACE_JOYNR_TESTS_IMULTIPLEVERSIONSINTERFACE2CONNECTOR_H
...
class  IMultipleVersionsInterface2Subscription{
	/**
	  ...
	  */
public:
	virtual ~IMultipleVersionsInterface2Subscription() = default;
...
class  IMultipleVersionsInterface2Connector: virtual public IMultipleVersionsInterface2, virtual public IMultipleVersionsInterface2Subscription{

public:
	~IMultipleVersionsInterface2Connector() override = default;
};


} // namespace tests
} // namespace joynr
#endif // GENERATED_INTERFACE_JOYNR_TESTS_IMULTIPLEVERSIONSINTERFACE2CONNECTOR_H
