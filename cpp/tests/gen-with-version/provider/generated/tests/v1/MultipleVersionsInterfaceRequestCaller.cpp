...
MultipleVersionsInterfaceRequestCaller::MultipleVersionsInterfaceRequestCaller(std::shared_ptr<joynr::tests::v1::MultipleVersionsInterfaceProvider> provider)
