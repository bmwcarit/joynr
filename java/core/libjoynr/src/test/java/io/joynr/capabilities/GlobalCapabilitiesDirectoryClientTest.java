...
public class GlobalCapabilitiesDirectoryClientTest {
    ...
    private static final long DEFAULT_TTL = 30L * 24L * 60L * 60L * 1000L;
    ...
    public void setup() {
        ...
        subject = new GlobalCapabilitiesDirectoryClient(proxyBuilderFactoryMock, capabilitiesDirectoryEntryMock);
    ...
    @Test
    public void testAdd() {
        messagingQos.setTtl_ms(DEFAULT_TTL);
