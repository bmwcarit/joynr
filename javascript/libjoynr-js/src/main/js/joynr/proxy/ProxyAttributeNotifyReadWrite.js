...
define(
        ...
        function(ProxyAttribute) {
            ...
            function ProxyAttributeNotifyReadWrite(parent, settings, attributeName, attributeType) {
                 ...
                 * @param {Number}
                 *            settings.subscriptionQos.minInterval defines how often an update may
                 *            be sent
                 * @param {Number}
                 *            settings.subscriptionQos.maxInterval defines how long to wait before
                 *            sending an update even if the value did
                 *            not change or when onChange is false
                 * @param {Number}
                 *            settings.subscriptionQos.expiryDate how long is the subscription valid
                 * @param {Number}
                 *            settings.subscriptionQos.alertAfterInterval defines how long to wait
                 *            for an update before publicationMissed is called
                 * @param {Number}
                 *            settings.subscriptionQos.publicationTtl time to live for publication
                 *            messages
                 *
                 * @param {string}
