...
public class BounceProxyInstanceLifeCycleTest extends AbstractServiceInterfaceTest {
    ...
    public void testStartBounceProxyThatIsAlreadyKnown() {
        ...
        Response response = //
        given(). //
               header("url4cc", "http://testurl/url4cc")
               .and()
               .header("url4bpc", "http://testurl/url4bpc")
               . //
               when()
               .post(serverUrl + "?bpid=0.0");
    ...
    public void testUpdateBounceProxy() {
        ...
        given(). //
               when()
               .put(serverUrl + "/0.0?activeLongPolls=5");
    ...
    public void testUpdateBounceProxyWithUnknownStatus() {
        ...
        given(). //
               when()
               .put(serverUrl + "/0.0?status=blablabla");
    ...
    public void testUpdateBounceProxyMultipleMeasures() {
        ...
        given(). //
               when()
               .put(serverUrl + "/0.0?activeLongPolls=5&assignedChannels=3");
    ...
    public void testShutdownBounceProxyInstance() {
        ...
        given(). //
               ...
               . //
               when()
               .put(serverUrl + "/0.0?status=shutdown");
