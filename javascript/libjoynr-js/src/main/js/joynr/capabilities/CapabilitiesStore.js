...
module.exports =
        (function(Typing) {
             ...
             */
            CapabilitiesStore.prototype._removeDiscoveryEntryFromStore =
             ...
             *
             */
            CapabilitiesStore.prototype._addDiscoveryEntryToStore =
                    function(discoveryEntry) {
                        ...
                        // by participant id
                        this._discoveryEntryStoreByParticipantId[discoveryEntry.participantId] =
                                discoveryEntry;
             ...
             *
             */
            CapabilitiesStore.prototype.add =
             ...
             */
            CapabilitiesStore.prototype._qosMatches =
                    function qosMatches(discoveryEntry, cacheMaxAge) {
                        return discoveryEntry !== undefined
                            && this._checkAge(discoveryEntry, cacheMaxAge);
                    };
             ...
             */
            CapabilitiesStore.prototype._filterEntries =
                    function filterEntries(entries, cacheMaxAge) {
             ...
             */
            CapabilitiesStore.prototype.lookup =
                    function lookup(settings) {
                        ...
                        if (settings.domains !== undefined && settings.interfaceName !== undefined) {
                            for (i = 0; i < settings.domains.length; ++i) {
                                ...
                                storedEntries =
                                        this._discoveryEntryStoreByDomainInterfaceName[key] || [];
                                returnValue =
                                        returnValue.concat(this._filterEntries(
                                                storedEntries,
                                                settings.cacheMaxAge));
                            }
                        } else if (settings.participantId !== undefined) {
                            storedEntries =
                                    this._discoveryEntryStoreByParticipantId[settings.participantId];
             ...
             * @returns {CapabilitiesStore} returns this for a fluent interface
             */
            CapabilitiesStore.prototype.remove =
