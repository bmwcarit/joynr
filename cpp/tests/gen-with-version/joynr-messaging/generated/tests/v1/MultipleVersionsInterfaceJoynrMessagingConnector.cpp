...
#include "joynr/tests/v1/MultipleVersionsInterfaceJoynrMessagingConnector.h"
...
std::shared_ptr<joynr::Future<joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct>> MultipleVersionsInterfaceJoynrMessagingConnector:: getVersionedStructAsync(
			const joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct& input,
			std::function<void(const joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct& result)> onSuccess,
			std::function<void(const joynr::exceptions::JoynrRuntimeException& error)> onRuntimeError,
			boost::optional<joynr::MessagingQos> qos
) noexcept
{
	...
	request.setParamDatatypes({
		"joynr.tests.v1.MultipleVersionsTypeCollection.VersionedStruct"
		});
	request.setParams(
		input
	);

	auto future = std::make_shared<joynr::Future<joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct>>();

	std::function<void(const joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct& result)> onSuccessWrapper = [
			future,
			onSuccess = std::move(onSuccess),
			requestReplyId = request.getRequestReplyId(),
			methodName = request.getMethodName()
	...
	try {
		...
		auto replyCaller = std::make_shared<joynr::ReplyCaller<joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct>>(std::move(onSuccessWrapper), std::move(onErrorWrapper));
		operationRequest(std::move(replyCaller), std::move(request), std::move(qos));
	} catch (const std::invalid_argument& exception) {
		auto joynrException = std::make_shared<joynr::exceptions::MethodInvocationException>(exception.what());
		future->onError(joynrException);
...
std::shared_ptr<joynr::Future<joynr::tests::v1::AnonymousVersionedStruct>> MultipleVersionsInterfaceJoynrMessagingConnector:: getAnonymousVersionedStructAsync(
			const joynr::tests::v1::AnonymousVersionedStruct& input,
			std::function<void(const joynr::tests::v1::AnonymousVersionedStruct& result)> onSuccess,
			std::function<void(const joynr::exceptions::JoynrRuntimeException& error)> onRuntimeError,
			boost::optional<joynr::MessagingQos> qos
) noexcept
{
	...
	request.setParamDatatypes({
		"joynr.tests.v1.AnonymousVersionedStruct"
		});
	request.setParams(
		input
	);

	auto future = std::make_shared<joynr::Future<joynr::tests::v1::AnonymousVersionedStruct>>();

	std::function<void(const joynr::tests::v1::AnonymousVersionedStruct& result)> onSuccessWrapper = [
			future,
			onSuccess = std::move(onSuccess),
			requestReplyId = request.getRequestReplyId(),
			methodName = request.getMethodName()
	...
	try {
		...
		auto replyCaller = std::make_shared<joynr::ReplyCaller<joynr::tests::v1::AnonymousVersionedStruct>>(std::move(onSuccessWrapper), std::move(onErrorWrapper));
		operationRequest(std::move(replyCaller), std::move(request), std::move(qos));
	} catch (const std::invalid_argument& exception) {
		auto joynrException = std::make_shared<joynr::exceptions::MethodInvocationException>(exception.what());
		future->onError(joynrException);
...
std::shared_ptr<joynr::Future<joynr::tests::v1::InterfaceVersionedStruct>> MultipleVersionsInterfaceJoynrMessagingConnector:: getInterfaceVersionedStructAsync(
			const joynr::tests::v1::InterfaceVersionedStruct& input,
			std::function<void(const joynr::tests::v1::InterfaceVersionedStruct& result)> onSuccess,
			std::function<void(const joynr::exceptions::JoynrRuntimeException& error)> onRuntimeError,
			boost::optional<joynr::MessagingQos> qos
) noexcept
{
	...
	request.setParamDatatypes({
		"joynr.tests.v1.InterfaceVersionedStruct"
		});
	request.setParams(
		input
	);

	auto future = std::make_shared<joynr::Future<joynr::tests::v1::InterfaceVersionedStruct>>();

	std::function<void(const joynr::tests::v1::InterfaceVersionedStruct& result)> onSuccessWrapper = [
			future,
			onSuccess = std::move(onSuccess),
			requestReplyId = request.getRequestReplyId(),
			methodName = request.getMethodName()
	...
	try {
		...
		auto replyCaller = std::make_shared<joynr::ReplyCaller<joynr::tests::v1::InterfaceVersionedStruct>>(std::move(onSuccessWrapper), std::move(onErrorWrapper));
		operationRequest(std::move(replyCaller), std::move(request), std::move(qos));
	} catch (const std::invalid_argument& exception) {
		auto joynrException = std::make_shared<joynr::exceptions::MethodInvocationException>(exception.what());
		future->onError(joynrException);
