...
namespace QJson {
  ...
  */
  ...
  public:
    ...
    /**
      * Registers a user-defined enum type so that it can be serialized as a string.
      * @param id The typeid of the enum type
      * @param meta A QMetaEnum that describes the enum
      */
    static void registerEnum( int id, const QMetaEnum& meta );

  private:
    Q_DISABLE_COPY(Serializer)
    class SerializerPrivate;
    SerializerPrivate* const d;
    QString turnMetaObjectIntoTypename(const QMetaObject* metaObject);
    static QMap<int,QMetaEnum>* enumIds;
    static QMutex* enumIdsMutex;
  };
}
