...
MultipleVersionsInterfaceProxy::MultipleVersionsInterfaceProxy(
		...
		MultipleVersionsInterfaceSyncProxy(runtime, connectorFactory, domain, qosSettings),
		MultipleVersionsInterfaceAsyncProxy(runtime, connectorFactory, domain, qosSettings)
{
}
