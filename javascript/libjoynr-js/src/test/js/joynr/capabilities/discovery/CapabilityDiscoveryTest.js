            ...
            describe(
                    ...
                    function() {
                        ...
                        beforeEach(function(done) {
                            ...
                            globalCapDirSpy =
                                    getSpiedLookupObjWithReturnValue("globalCapDirSpy", Promise.resolve({ result: [] }));
                        ...
                        it(
                                ...
                                function(done) {
                                    localCapStoreSpy.lookup.and.returnValue([ getDiscoveryEntry(
                                            domain,
                                            interfaceName)
                                    ]);
                                    capabilityDiscovery.lookup([domain], interfaceName, discoveryQos);
                        ...
                        it(
                                ...
                                function(done) {
                                    globalCapCacheSpy.lookup.and.returnValue([ getDiscoveryEntry(
                                            domain,
                                            interfaceName)
                                    ]);
                                    discoveryQos.discoveryScope = DiscoveryScope.GLOBAL_ONLY;
                        ...
                        function testDiscoveryResult(
                            ...
                            return capabilityDiscovery.lookup([domain], interfaceName, discoveryQos)
