...
//#######################################################
// #####################################################
#ifndef GENERATED_TYPE_JOYNR_TESTS_V1_MULTIPLEVERSIONSTYPECOLLECTION_VERSIONEDSTRUCT_H
#define GENERATED_TYPE_JOYNR_TESTS_V1_MULTIPLEVERSIONSTYPECOLLECTION_VERSIONEDSTRUCT_H
...
{
archive(
		muesli::make_nvp("flag1", versionedstructObj.flag1)
);
}
...
/**
 * @brief Function object that implements a hash function for joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct.
 *
 ...
 */
template<>
struct hash<joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct> {
	 ...
	 */
	std::size_t operator()(const joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct& versionedStructValue) const {
		return joynr::tests::v1::MultipleVersionsTypeCollection::hash_value(versionedStructValue);
	}
};
} // namespace std

MUESLI_REGISTER_TYPE(joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct, "joynr.tests.v1.MultipleVersionsTypeCollection.VersionedStruct")

#endif // GENERATED_TYPE_JOYNR_TESTS_V1_MULTIPLEVERSIONSTYPECOLLECTION_VERSIONEDSTRUCT_H
