 ...
 * {@link io.joynr.jeeintegration.api.JeeIntegrationPropertyKeys#PROPERTY_KEY_MQTT_ENABLE_SHARED_SUBSCRIPTIONS} property
 * is set to <code>true</code>, then the shared subscription versions of the messaging skeleton is used.
 *
