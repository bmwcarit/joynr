...
//#######################################################
// #####################################################
#ifndef GENERATED_TYPE_JOYNR_TESTS_V2_MULTIPLEVERSIONSTYPECOLLECTION_VERSIONEDSTRUCT_H
#define GENERATED_TYPE_JOYNR_TESTS_V2_MULTIPLEVERSIONSTYPECOLLECTION_VERSIONEDSTRUCT_H
...
/**
 * @brief Function object that implements a hash function for joynr::tests::v2::MultipleVersionsTypeCollection::VersionedStruct.
 *
 ...
 */
template<>
struct hash<joynr::tests::v2::MultipleVersionsTypeCollection::VersionedStruct> {
	 ...
	 */
	std::size_t operator()(const joynr::tests::v2::MultipleVersionsTypeCollection::VersionedStruct& versionedStructValue) const {
		return joynr::tests::v2::MultipleVersionsTypeCollection::hash_value(versionedStructValue);
	}
};
} // namespace std

MUESLI_REGISTER_TYPE(joynr::tests::v2::MultipleVersionsTypeCollection::VersionedStruct, "joynr.tests.v2.MultipleVersionsTypeCollection.VersionedStruct")

#endif // GENERATED_TYPE_JOYNR_TESTS_V2_MULTIPLEVERSIONSTYPECOLLECTION_VERSIONEDSTRUCT_H
