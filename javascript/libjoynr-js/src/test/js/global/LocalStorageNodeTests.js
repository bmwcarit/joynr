 ...
 *
 * Sets the default storage path of LocalStorage to a sub-folder of the build directory with a
 * unique identifier appended to the folder name.
 *
...
const LocalStorageWrapper = function(settings) {
    settings = settings || {};
    settings.location = settings.location || `localStorageTestResults/LocalStorage-${nanoid()}`;
