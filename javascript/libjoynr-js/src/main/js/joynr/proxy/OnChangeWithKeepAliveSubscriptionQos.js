...
class OnChangeWithKeepAliveSubscriptionQos {
     ...
     * @param {Number} [settings.minIntervalMs] defines how often an update may
     *            be sent
     * @param {Number} [settings.maxIntervalMs=OnChangeWithKeepAliveSubscriptionQos.DEFAULT_MAX_INTERVAL_MS]
     ...
     *            </ul>
     * @param {Number} [settings.expiryDateMs] how long is the subscription valid
     * @param {Number} [settings.validityMs] The validity of the subscription relative to the current time.
     * @param {Number} [settings.alertAfterIntervalMs=OnChangeWithKeepAliveSubscriptionQos.DEFAULT_ALERT_AFTER_INTERVAL_MS]
     ...
     *            </ul>
     * @param {Number} [settings.publicationTtlMs] time to live for publication
     *            messages
     *
