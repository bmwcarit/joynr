        ...
        function(
            ...
            describe(
                    ...
                    function() {
                        ...
                        it(
                                ...
                                function() {
                                    ...
                                    expect(
                                            ...
                                            .toBeTruthy();
                                    expect(radioProvider.operationWithEnumsAsInputAndOutput)
                                            .toBeDefined();
                                    expect(
                                            radioProvider.operationWithEnumsAsInputAndOutput instanceof ProviderOperation)
                                            .toBeTruthy();
                                    expect(
                                            radioProvider.operationWithEnumsAsInputAndEnumArrayAsOutput)
                                            .toBeDefined();
                                    expect(
                                            radioProvider.operationWithEnumsAsInputAndEnumArrayAsOutput instanceof ProviderOperation)
                                            .toBeTruthy();
                        ...
                        it(
                                "RadioProvider recognizes multiple missing implementation functions",
                                function() {
                                    delete implementation.isOn.get;
                                    delete implementation.addFavoriteStation;
                                    var radioProvider =
                                            new RadioProvider(implementation, dependencies);
                                    expect(radioProvider.checkImplementation).toBeDefined();
                                    expect(radioProvider.checkImplementation()).toBeTruthy();
