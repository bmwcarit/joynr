...
namespace QJson {
  ...
  */
  class QJSON_EXPORT QObjectHelper {
    ...
    */
    static QVariantMap qobject2qvariant(
    ...
    */
    ...
    static int getClassIdForTransmittedType(const QString& typeName);
    private:
      static void transformElementsOfQVariantList(QVariantList& variantList);
      static void transformElementsOfQVariantMap(QVariantMap& variantMap, QVariantMap& variantMapNew);
      static QString typenameKey;
      static void assertClassId(int classId, const QString& typeName);
