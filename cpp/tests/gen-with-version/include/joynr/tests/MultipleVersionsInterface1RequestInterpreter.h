...
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1REQUESTINTERPRETER_H
#define GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1REQUESTINTERPRETER_H
...
/** @brief RequestInterpreter class for interface MultipleVersionsInterface1 */
class  MultipleVersionsInterface1RequestInterpreter: public joynr::IRequestInterpreter {
public:
	/** @brief Default constructor */
	MultipleVersionsInterface1RequestInterpreter() = default;

	/** @brief Destructor */
	~MultipleVersionsInterface1RequestInterpreter() override = default;
...
private:
	DISALLOW_COPY_AND_ASSIGN(MultipleVersionsInterface1RequestInterpreter);
	ADD_LOGGER(MultipleVersionsInterface1RequestInterpreter)
};


} // namespace tests
} // namespace joynr
#endif // GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1REQUESTINTERPRETER_H
