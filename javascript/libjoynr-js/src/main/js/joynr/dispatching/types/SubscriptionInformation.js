...
class SubscriptionInformation {
     ...
     * @constructor
     * @param {String} proxyParticipantId Id of the proxy
     * @param {String} providerParticipantId Id of the provider
     * @param {Object|SubscriptionRequest} [request] the subscription request
     */
    constructor(subscriptionType, proxyParticipantId, providerParticipantId, request) {
