...
describe(
        ...
        function() {
            ...
            it("Strategy 'Nothing' does nothing", function() {
                expect(ArbitrationStrategyCollection.Nothing(getDiscoveryEntryList())).toEqual(
                        getDiscoveryEntryList());
            });
            ...
            it("Strategy 'HighestPriority' includes all capability infos", function() {
                ...
                var highestPriority =
                        ArbitrationStrategyCollection.HighestPriority(discoveryEntryList);
            ...
            it("Strategy 'HighestPriority' sorts according to providerQos priority", function() {
                var highestPriority =
                        ArbitrationStrategyCollection.HighestPriority(getDiscoveryEntryList());
                var i;
            ...
            it(
                    ...
                    function() {
                         ...
                         */
                        var keywordCapInfoList =
                                ArbitrationStrategyCollection.Keyword(keyword, discoveryEntryList);
