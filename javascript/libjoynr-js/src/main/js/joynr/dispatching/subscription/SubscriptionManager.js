...
class SubscriptionManager {
    ...
    constructor(dispatcher) {
        ...
        /**
         * @param {String} subscriptionId Id of the subscription to check
         * @param {Number} delay_ms Delay to the next publication check.
        ...
        /**
         * @param {String} subscriptionId Id of the subscription to check
         * @param {Number} alertAfterIntervalMs maximum delay between two incoming publications
         */
         ...
         * @param {String} settings.proxyId participantId of the sender
         * @param {DiscoveryEntryWithMetaInfo} settings.providerDiscoveryEntry DiscoveryEntry of the receiver
         * @param {String} settings.attributeType the type of the subscribing attribute
         * @param {String} settings.attributeName the attribute name to subscribe to
         * @param {SubscriptionQos} [settings.qos] the subscriptionQos
         * @param {String} settings.subscriptionId optional parameter subscriptionId to reuse a
         *            preexisting identifier for this concrete subscription request
         * @param {SubscriptionManager~onReceive} settings.onReceive the callback for received publications.
         * @param {SubscriptionManager~onError} settings.onError the callback for missing publication alerts or when an
         *            error occurs.
         * @param {SubscriptionManager~onSubscribed} settings.onSubscribed the callback to inform once the subscription request has
         ...
         * @param {String} parameters.proxyId participantId of the sender
         * @param {DiscoveryEntryWithMetaInfo} parameters.providerDiscoveryEntry DiscoveryEntry of the receiver
         * @param {String} parameters.broadcastName the name of the broadcast being subscribed to
         * @param {String[]} parameters.broadcastParameter the parameter meta information of the broadcast being subscribed to
         * @param {SubscriptionQos} [parameters.subscriptionQos] the subscriptionQos
         * @param {BroadcastFilterParameters} [parameters.filterParameters] filter parameters used to indicate interest in
         *            only a subset of broadcasts that might be sent.
         * @param {Boolean} parameters.selective true if broadcast is selective
         * @param {String[]} [parameters.partitions] partitions for multicast requests
         * @param {String} parameters.subscriptionId optional parameter subscriptionId to reuse a
         ...
         * @param {String} settings.subscriptionId of the subscriptionId to stop
         ...
         * @returns {Promise} - resolves if subscriptionStop message has been sent for each active subscription
