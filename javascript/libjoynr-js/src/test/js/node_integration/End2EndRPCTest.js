/*global fail: true, fdescribe: true, fit: true, xit: true */
                ...
                setAndTestAttribute(attributeName, recursions - 1)
                    ...
                    .catch(function(error) {
                        return IntegrationUtils.outputPromiseError(
                            new Error(
                                "End2EndRPCTest.setAndTestAttributeTester. Error while calling setAndTest: " +
                                    error.message
                            )
                        );
                    });
            ...
            it("can call an operation and get an ApplicationException (Provider sync, String parameter)", function(
                ...
                waitsFor(
                    ...
                    .then(function() {
                        ...
                        expect(catchSpy.calls.argsFor(0)[0].error).toEqual(
                            jasmine.objectContaining(ErrorList.EXAMPLE_ERROR_2)
                        );
                        done();
                        return null;
                    })
            ...
            it("can call an operation and get an ApplicationException (Provider async, String parameter)", function(
                ...
                waitsFor(
                    ...
                    .then(function() {
                        ...
                        expect(catchSpy.calls.argsFor(0)[0].error).toEqual(
                            jasmine.objectContaining(ErrorList.EXAMPLE_ERROR_1)
                        );
                        done();
                        return null;
                    })
