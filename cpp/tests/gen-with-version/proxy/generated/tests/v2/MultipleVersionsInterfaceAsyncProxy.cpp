...
#include "joynr/tests/v2/MultipleVersionsInterfaceAsyncProxy.h"
 ...
 * getVersionedStruct
 */
std::shared_ptr<joynr::Future<joynr::tests::v2::MultipleVersionsTypeCollection::VersionedStruct>> MultipleVersionsInterfaceAsyncProxy:: getVersionedStructAsync(
 ...
 */
std::shared_ptr<joynr::Future<joynr::tests::v2::AnonymousVersionedStruct>> MultipleVersionsInterfaceAsyncProxy:: getAnonymousVersionedStructAsync(
 ...
 */
std::shared_ptr<joynr::Future<joynr::tests::v2::InterfaceVersionedStruct>> MultipleVersionsInterfaceAsyncProxy:: getInterfaceVersionedStructAsync(
