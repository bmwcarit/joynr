...
define(
    ...
    function(Promise, joynr, RadioProxy, IntegrationUtils, provisioning, uuid, waitsFor) {
        function End2EndAbstractTest(provisioningSuffix) {
                    ...
                    return new Promise(function(resolve, reject) {
                        IntegrationUtils.initializeWebWorker(
                            ...
                            .then(function(newRadioProxy) {
                                ...
                                radioProxy.nonExistingAttributeOnProviderSide = new radioProxy.settings.proxyElementTypes.ProxyAttributeNotifyReadWrite(
                                    radioProxy,
                                    radioProxy.settings,
            ...
            function setAndTestAttributeRecursive(attribute, index, resolve, reject) {
                ...
                attribute
                    ...
                    .then(function() {
                        ...
                        attribute
                            .get()
                            .then(function(valueFromProvider) {
                            ...
                            .catch(function(error) {
                                reject(
                                    new Error(
                                        "Failed to retrieve attribute value (recursion index " + index + "): " + error
                                    )
                                );
                            });
                        return null;
            ...
            this.getFailingAttribute = function(attributeName) {
                ...
                return waitsFor(
                    ...
                    .then(function() {
                        ...
                        expect(catchSpy.calls.argsFor(0)[0]._typeName).toEqual(
            ...
            this.callOperation = function(operationName, opArgs, expectation) {
                ...
                radioProxy[operationName](opArgs)
                    ...
                    .catch(function(error) {
                        return IntegrationUtils.outputPromiseError(
                            new Error(
                                "End2EndAbstractTest.callOperation. Error while calling operation: " + error.message
                            )
                        );
                    });
            ...
            this.setupSubscriptionAndReturnSpy = function(subscribingEntity, subscriptionQos, partitions) {
                ...
                promise = radioProxy[subscribingEntity]
                    ...
                    .catch(function(error) {
                        return IntegrationUtils.outputPromiseError(
                            new Error(
                                "End2EndAbstractTest.setupSubscriptionAndReturnSpy. Error while subscribing: " +
                                    error.message
                            )
                        );
                    });
            ...
            this.afterEach = function(done) {
                IntegrationUtils.shutdownWebWorker(workerId)
                    .then(function() {
