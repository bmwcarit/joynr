...
@ProvidesJoynrTypesInfo(interfaceClass = Echo.class, interfaceName = "tests/graceful/shutdown/Echo")
@SuppressWarnings("unused")
public interface Echo {
	public static String INTERFACE_NAME = "tests/graceful/shutdown/Echo";
