...
@ProvidesJoynrTypesInfo(interfaceClass = HeaderPing.class, interfaceName = "examples/customheaders/HeaderPing")
@SuppressWarnings("unused")
public interface HeaderPing {
	public static String INTERFACE_NAME = "examples/customheaders/HeaderPing";
