...
//#######################################################
// #####################################################
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACEPROVIDER_H
#define GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACEPROVIDER_H
...
template <>
struct RequestCallerTraits<joynr::tests::MultipleVersionsInterfaceProvider>
{
	using RequestCaller = joynr::tests::MultipleVersionsInterfaceRequestCaller;
};

} // namespace joynr

#endif // GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACEPROVIDER_H
