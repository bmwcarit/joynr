...
{
    setPublicationTtlMs(publicationTtlMsLocal);
}
...
void UnicastSubscriptionQos::setPublicationTtlMs(std::int64_t publicationTtlMsLocal)
{
    this->publicationTtlMs = publicationTtlMsLocal;
