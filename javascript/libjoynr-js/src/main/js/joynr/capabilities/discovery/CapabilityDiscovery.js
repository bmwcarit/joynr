...
class CapabilityDiscovery {
     ...
     *
     * @param {CapabilitiesStore} localCapabilitiesStore the local capabilities store
     * @param {CapabilitiesStore} globalCapabilitiesCache the cache for the global capabilities directory
     * @param {MessageRouter} messageRouter the message router
     * @param {ProxyBuilder} proxyBuilder the proxy builder used to create the GlobalCapabilitiesDirectoryProxy
     * @param {String} globalCapabilitiesDomain the domain to communicate with the GlobalCapablitiesDirectory
     *                                     GlobalCapab
     *
     */
    constructor(
         ...
         *
         * @param {Address} globalAddress the address used to register discovery entries globally
         */
         ...
         * @param {String} domains the domains
         * @param {String} interfaceName the interface name
         * @param {DiscoveryQos} discoveryQos the DiscoveryQos giving the strategy for discovering a capability
         ...
         *
         * @param {String} domain of the capability
         * @param {String} interfaceName of the capability
         * @param {String} participantId of the capability
         * @param {ProviderQos} providerQos of the capability
         * @param {Array} array of communication middlewares
         *
         * @returns {Object} an A+ promise
         */
         ...
         *
         * @param {String} participantId to remove
         *
         * @returns {Object} an A+ promise
         */
