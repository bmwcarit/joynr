...
//#######################################################
// #####################################################
#ifndef GENERATED_TYPE_JOYNR_TESTS_ANONYMOUSVERSIONEDSTRUCT_H
#define GENERATED_TYPE_JOYNR_TESTS_ANONYMOUSVERSIONEDSTRUCT_H
...
/**
 * @brief Function object that implements a hash function for joynr::tests::AnonymousVersionedStruct.
 *
 ...
 */
template<>
struct hash<joynr::tests::AnonymousVersionedStruct> {
	 ...
	 */
	std::size_t operator()(const joynr::tests::AnonymousVersionedStruct& anonymousVersionedStructValue) const {
		return joynr::tests::hash_value(anonymousVersionedStructValue);
	}
};
} // namespace std

MUESLI_REGISTER_TYPE(joynr::tests::AnonymousVersionedStruct, "joynr.tests.AnonymousVersionedStruct")

#endif // GENERATED_TYPE_JOYNR_TESTS_ANONYMOUSVERSIONEDSTRUCT_H
