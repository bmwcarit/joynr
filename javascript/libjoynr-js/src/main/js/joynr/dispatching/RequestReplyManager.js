...
class RequestReplyManager {
    ...
    constructor(dispatcher) {
         ...
         * @param {MessagingQos} settings.messagingQos quality-of-service parameters such as time-to-live
         * @param {Request} settings.request the Request to send
         ...
         * @param {DiscoveryEntryWithMetaInfo} settings.toDiscoveryEntry DiscoveryEntry of the receiver
         * @param {MessagingQos} settings.messagingQos quality-of-service parameters such as time-to-live
         * @param {OneWayRequest} settings.request the Request to send
         * @returns {Promise} the Promise for the Request
         */
         ...
         * @function
         *
         * @param {String} participantId of the provider receiving the incoming requests
         ...
         * @function
         *
         * @param {String} requestReplyId
         * @param {ReplyCaller} replyCaller
         * @param {Number} ttl_ms relative number of milliseconds to wait for the reply.
