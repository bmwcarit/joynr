...
public:
    MOCK_METHOD2(add,
                 void(const joynr::types::DiscoveryEntry& entry,
    ...
    MOCK_METHOD4(add,
                 void(const joynr::types::DiscoveryEntry& discoveryEntry,
                      const bool& awaitGlobalRegistration,
                      const std::vector<std::string>& gbids,
                      boost::optional<joynr::MessagingQos> qos));

    MOCK_METHOD3(addToAll,
                 void(const joynr::types::DiscoveryEntry& discoveryEntry,
                      const bool& awaitGlobalRegistration,
                      boost::optional<joynr::MessagingQos> qos));

    MOCK_METHOD3(lookup,
                 void(joynr::types::DiscoveryEntryWithMetaInfo& result,
    ...
    MOCK_METHOD5(lookup,
                 void(std::vector<joynr::types::DiscoveryEntryWithMetaInfo>& result,
    ...
    MOCK_METHOD2(remove,
                 void(const std::string& participantId, boost::optional<joynr::MessagingQos> qos));
    ...
    {
        return addAsyncMock(
                discoveryEntry, std::move(onSuccess), std::move(onRuntimeError), std::move(qos));
    }
    MOCK_METHOD4(addAsyncMock,
    ...
    MOCK_METHOD6(addToAllAsyncMock,
                 std::shared_ptr<joynr::Future<void>>(
                         const joynr::types::DiscoveryEntry& discoveryEntry,
                         const bool& awaitGlobalRegistration,
                         std::function<void(void)> onSuccess,
    ...
    std::shared_ptr<joynr::Future<joynr::types::DiscoveryEntryWithMetaInfo>> lookupAsync(
            ...
            boost::optional<joynr::MessagingQos> qos) noexcept override
    {
        return lookupAsyncMock(
                participantId, std::move(onSuccess), std::move(onRuntimeError), std::move(qos));
    }
    MOCK_METHOD4(lookupAsyncMock,
    ...
    std::shared_ptr<joynr::Future<joynr::types::DiscoveryEntryWithMetaInfo>> lookupAsync(
            ...
            boost::optional<joynr::MessagingQos> qos) noexcept override
    {
        return lookupAsyncMock(participantId,
                               discoveryQos,
                               gbids,
                               std::move(onSuccess),
                               std::move(onApplicationError),
    ...
    lookupAsync(
            ...
            boost::optional<joynr::MessagingQos> qos) noexcept override
    {
        return lookupAsyncMock(domains,
                               interfaceName,
                               discoveryQos,
                               gbids,
                               std::move(onSuccess),
    ...
    std::shared_ptr<joynr::Future<void>> removeAsync(
            ...
            boost::optional<joynr::MessagingQos> qos) noexcept override
    {
        return removeAsyncMock(
                participantId, std::move(onSuccess), std::move(onRuntimeError), std::move(qos));
    }
    MOCK_METHOD4(removeAsyncMock,
                 std::shared_ptr<joynr::Future<void>>(
                         const std::string& participantId,
                         std::function<void(void)> onSuccess,
                         std::function<void(const joynr::exceptions::JoynrRuntimeException& error)>
