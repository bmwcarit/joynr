...
public class ChannelService {
    ...
    public GenericEntity<List<ChannelInformation>> listChannels() {
        try {
            return new GenericEntity<List<ChannelInformation>>(channelServiceDelegate.listChannels()) {
            };
        } catch (Throwable e) {
    ...
    public Broadcastable open(@PathParam("ccid") String ccid,
        ...
        try {
            return channelServiceDelegate.openChannel(ccid, cacheIndex, atmosphereTrackingId);
    ...
    public Response createChannel(@QueryParam("ccid") String ccid,
        ...
        ChannelInformation channelInfo = channelServiceDelegate.getChannelInformation(ccid);
        ...
        channelInfo = channelServiceDelegate.createChannel(ccid, atmosphereTrackingId);
    ...
    public Response deleteChannel(@PathParam("ccid") String ccid) {
        try {
            ...
            channelServiceDelegate.deleteChannel(ccid);
