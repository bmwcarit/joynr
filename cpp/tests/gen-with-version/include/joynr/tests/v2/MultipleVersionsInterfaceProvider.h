...
//#######################################################
// #####################################################
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_V2_MULTIPLEVERSIONSINTERFACEPROVIDER_H
#define GENERATED_INTERFACE_JOYNR_TESTS_V2_MULTIPLEVERSIONSINTERFACEPROVIDER_H
...
template <>
struct RequestCallerTraits<joynr::tests::v2::MultipleVersionsInterfaceProvider>
{
	using RequestCaller = joynr::tests::v2::MultipleVersionsInterfaceRequestCaller;
};

} // namespace joynr

#endif // GENERATED_INTERFACE_JOYNR_TESTS_V2_MULTIPLEVERSIONSINTERFACEPROVIDER_H
