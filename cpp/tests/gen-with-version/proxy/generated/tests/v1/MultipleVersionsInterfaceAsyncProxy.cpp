...
#include "joynr/tests/v1/MultipleVersionsInterfaceAsyncProxy.h"
 ...
 * getVersionedStruct
 */
std::shared_ptr<joynr::Future<joynr::tests::v1::MultipleVersionsTypeCollection::VersionedStruct>> MultipleVersionsInterfaceAsyncProxy:: getVersionedStructAsync(
 ...
 */
std::shared_ptr<joynr::Future<joynr::tests::v1::AnonymousVersionedStruct>> MultipleVersionsInterfaceAsyncProxy:: getAnonymousVersionedStructAsync(
 ...
 */
std::shared_ptr<joynr::Future<joynr::tests::v1::InterfaceVersionedStruct>> MultipleVersionsInterfaceAsyncProxy:: getInterfaceVersionedStructAsync(
