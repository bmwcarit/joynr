...
const asRead = (function() {
    /**
         ...
         * @function
         *
         * @param {Function} getterFunc - the getter function with the signature '{?} getterFunc() {..}'
         * @returns {ProviderAttribute} fluent interface to call multiple methods
         */
...
class ProviderAttribute {
     ...
     * @constructor
     *
     * @param {Provider} parent - the provider object that contains this attribute
     * @param {Object} [implementation] - the definition of attribute implementation
     ...
     */
    constructor(parent, implementation, attributeName, attributeType, attributeCaps) {
        this.parent = parent;
