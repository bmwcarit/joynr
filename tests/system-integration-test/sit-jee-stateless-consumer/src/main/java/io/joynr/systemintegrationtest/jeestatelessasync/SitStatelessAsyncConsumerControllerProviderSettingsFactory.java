...
@Singleton
public class SitStatelessAsyncConsumerControllerProviderSettingsFactory implements ProviderRegistrationSettingsFactory {
    ...
    public boolean providesFor(Class<?> serviceInterface) {
        return SitControllerSync.class.equals(serviceInterface);
    }
