...
public class QoSCacheEntryTimeToLiveCompatibility extends QoSTimeComparisonCompatibility {

    public QoSCacheEntryTimeToLiveCompatibility(QualityOfService qos) {
        super(qos);
    }
