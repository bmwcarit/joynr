...
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_IMULTIPLEVERSIONSINTERFACE1CONNECTOR_H
#define GENERATED_INTERFACE_JOYNR_TESTS_IMULTIPLEVERSIONSINTERFACE1CONNECTOR_H
...
class  IMultipleVersionsInterface1Subscription{
	/**
	  ...
	  */
public:
	virtual ~IMultipleVersionsInterface1Subscription() = default;
...
class  IMultipleVersionsInterface1Connector: virtual public IMultipleVersionsInterface1, virtual public IMultipleVersionsInterface1Subscription{

public:
	~IMultipleVersionsInterface1Connector() override = default;
};


} // namespace tests
} // namespace joynr
#endif // GENERATED_INTERFACE_JOYNR_TESTS_IMULTIPLEVERSIONSINTERFACE1CONNECTOR_H
