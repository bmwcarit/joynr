...
public class JoynrConfigurationProvider {
    ...
    public Properties joynrProperties() {
        ...
        joynrProperties.setProperty(MessagingPropertyKeys.CHANNELID, "io.joynr.examples.customheaders.jee.consumer");
    ...
    public String joynrLocalDomain() {
        return "io.joynr.examples.customheaders.jee.consumer";
    }
