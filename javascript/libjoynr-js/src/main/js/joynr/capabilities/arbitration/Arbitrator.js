...
function(Promise, DiscoveryQos, Util, DiscoveryException, NoCompatibleProviderFoundException, LongTimer) {
    ...
    capabilityDiscoveryStub, domains, interfaceName, applicationDiscoveryQos, proxyVersion, deferred) {
        ...
        function retryCapabilityDiscovery (errorMsg) {
            ...
            deferred.discoveryRetryTimer = LongTimer.setTimeout(discoveryCapabilitiesRetry,
    ...
    Arbitrator.prototype.startArbitration = function startArbitration(settings) {
        ...
        function arbitrationResolver(resolve, reject){
            ...
            if (settings.staticArbitration && that._staticCapabilities) {
                ...
                LongTimer.setTimeout(discoveryCapabilitiesTimeOutHandler.bind(this),
                ...
                discoverCapabilities(
                that._capabilityDiscoveryStub, settings.domains, settings.interfaceName,
                settings.discoveryQos, settings.proxyVersion, deferred);
            }
        }
