									...
									get : function () {
										...
										try {
											...
											for (;;) {
												...
												// r is the result array from matching the tokenizing regular
												// expression.
												// r[0] contains everything that matched, including any initial
												// whitespace.
												// r[1] contains any punctuation that was matched, or true,
												// false, or null.
												// r[2] contains a matched number, still in string form.
												// r[3] contains a matched string, without quotes but with
												// escapement.
