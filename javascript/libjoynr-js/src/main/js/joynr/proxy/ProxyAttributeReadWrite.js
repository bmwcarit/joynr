...
define("joynr/proxy/ProxyAttributeReadWrite", [ "joynr/proxy/ProxyAttribute"
     ...
     */
    function ProxyAttributeReadWrite(parent, settings, attributeName, attributeType) {
        if (!(this instanceof ProxyAttributeReadWrite)) {
            // in case someone calls constructor without new keyword (e.g. var c = Constructor({..}))
            return new ProxyAttributeReadWrite(parent, settings, attributeName, attributeType);
        }

        var proxyAttribute =
                new ProxyAttribute(parent, settings, attributeName, attributeType, "READWRITE");

        /**
         * Getter for attribute
         *
         * @name ProxyAttributeReadWrite#get
         * @function
         *
         * @param {Object}
         *            [settings] the settings object for this function call
         ...
         *
         * @name ProxyAttributeReadWrite#set
         * @function
         *
         * @param {Object}
         *            settings the settings object for this function call
    ...
    return ProxyAttributeReadWrite;
