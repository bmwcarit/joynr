...
public class DefaultMqttTopicPrefixProviderTest {
    ...
    @Before
    public void setup() {
        mqttTopicProviderInstance = new DefaultMqttTopicPrefixProvider();
    }
    ...
    public void testGetMulticastTopicPrefix() {
        ...
        assertEquals(expectedTopicPrefix, topicPrefix);
    }
    ...
    public void testGetReplyToTopicPrefix() {
        ...
        String expectedTopicPrefix = DefaultMqttTopicPrefixProvider.REPLYTO_PREFIX;
        assertEquals(expectedTopicPrefix, topicPrefix);
    }
