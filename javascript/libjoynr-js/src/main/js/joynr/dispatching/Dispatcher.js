...
class Dispatcher {
     ...
     * @constructor
     *
     * @param {MessagingStub} clusterControllerMessagingStub for sending outgoing joynr messages
     * @param {PlatformSecurityManager} securityManager for setting the creator user ID header
     */
    constructor(clusterControllerMessagingStub, securityManager, ttlUpLiftMs) {
         ...
         * @param {String} settings.from participantId of the sender
         * @param {DiscoveryEntryWithMetaInfo} settings.toDiscoveryEntry DiscoveryEntry of the receiver
         * @param {MessagingQos} settings.messagingQos the messaging Qos object for the ttl
         */
         ...
         * @function
         *
         * @param {RequestReplyManager} requestReplyManager handles incoming and outgoing requests and replies
         *
         */
         ...
         * @function
         *
         * @param {MessageRouter} newMessageRouter
         *
         */
         ...
         * @function
         *
         * @param {SubscriptionManager} subscriptionManager sends subscription requests; handles incoming publications and incoming replies to
         ...
         * @function
         *
         * @param {PublicationManager} publicationManager sends publications; handles incoming subscription start and stop requests
         */
         ...
         * @param {DiscoveryEntryWithMetaInfo} settings.toDiscoveryEntry DiscoveryEntry of the receiver
         * @param {MessagingQos} settings.messagingQos the messaging Qos object for the ttl
         * @param {OneWayRequest} settings.request
         * @returns {Object} A+ promise object
         */
         ...
         * @param {DiscoveryEntryWithMetaInfo} settings.toDiscoveryEntry DiscoveryEntry of the receiver
         * @param {MessagingQos} settings.messagingQos the messaging Qos object for the ttl
         * @param {SubscriptionRequest} settings.subscriptionRequest
         ...
         * @param {DiscoveryEntryWithMetaInfo} settings.toDiscoveryEntry DiscoveryEntry of the receiver
         * @param {MessagingQos} settings.messagingQos the messaging Qos object for the ttl
         * @param {BroadcastSubscriptionRequest} settings.subscriptionRequest
         * @returns {Object}  promise object that is resolved when the request is sent by the messaging stub
         */
         ...
         * @param {String} settings.from participantId of the sender
         * @param {DiscoveryEntryWithMetaInfo} settings.toDiscoveryEntry DiscoveryEntry of the receiver
         * @param {String} settings.multicastId of the multicast
         * @param {SubscriptionStop} settings.subscriptionStop
         * @param {MessagingQos} settings.messagingQos the messaging Qos object for the ttl
         * @returns {Object} A+ promise object
         */
         ...
         * @param {Object} settings
         * @param {String} settings.from participantId of the sender
         * @param {String} settings.to participantId of the receiver
         * @param {Number} settings.expiryDate time-to-live
         * @param {Object} settings.customHeaders custom headers from request
         * @param {String} settings.messageType
         * @param {String} settings.effort
         * @param {boolean} settings.compress
         * @param {Reply|SubscriptionReply} settings.reply the reply to be transmitted. It can either be a Reply or a SubscriptionReply object
         * @returns {Object} A+ promise object
         */
         ...
         * @param {Number} settings.expiryDate time-to-live
         * @param {Object} settings.customHeaders custom headers from request
         * @param {SubscriptionReply} subscriptionReply
         */
         ...
         * @param {String} settings.to participantId of the receiver
         * @param {Number} settings.expiryDate time-to-live
         * @param {SubscriptionPublication} publication
         * @param {?} [publication.response]
         * @param {?} [publication.error]
         * @param {String} publication.subscriptionId
         *
         */
         ...
         * @param {Object} settings
         * @param {String} settings.from participantId of the sender
         * @param {String} settings.multicastName name of multicast
         * @param {String[]} partitions partitions for this multicast
         * @param {Number} settings.expiryDate time-to-live
         * @param {SubscriptionPublication} publication
         * @param {?} [publication.response]
         * @param {?} [publication.error]
         * @param {String} publication.multicastId
         *
         */
         ...
         * @function
         * @param {JoynrMessage} joynrMessage being routed
         */
        this.receive = function receive(joynrMessage) {
            ...
            switch (joynrMessage.type) {
                ...
                case JoynrMessage.JOYNRMESSAGE_TYPE_SUBSCRIPTION_REQUEST:
                    try {
                        const subscriptionRequest = upLiftExpiryDateInSubscriptionRequest(
                ...
                case JoynrMessage.JOYNRMESSAGE_TYPE_BROADCAST_SUBSCRIPTION_REQUEST:
                    try {
                        ...
                        // TODO handle error in handling the subscriptionRequest
                        log.error(
                            `error handling broadcastSubscriptionRequest: ${errorInBroadcastSubscriptionRequest}`
                        );
                    }
                    break;
                ...
                case JoynrMessage.JOYNRMESSAGE_TYPE_MULTICAST_SUBSCRIPTION_REQUEST:
                    try {
                        ...
                        // TODO handle error in handling the subscriptionRequest
                        log.error(
                            `error handling multicastSubscriptionRequest: ${errorInMulticastSubscriptionRequest}`
                        );
                    }
                    break;
