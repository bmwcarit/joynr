...
class MulticastSubscriptionQos extends SubscriptionQos {
    /**
     * @classdesc
     ...
     */
    public constructor(settings?: { expiryDateMs?: number; validityMs?: number }) {
        super(settings);
        this._typeName = "joynr.MulticastSubscriptionQos";
    }
}

export = MulticastSubscriptionQos;
