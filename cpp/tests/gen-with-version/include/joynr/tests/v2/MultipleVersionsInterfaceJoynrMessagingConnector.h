...
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_V2_MULTIPLEVERSIONSINTERFACEJOYNRMESSAGINGCONNECTOR_H
#define GENERATED_INTERFACE_JOYNR_TESTS_V2_MULTIPLEVERSIONSINTERFACEJOYNRMESSAGINGCONNECTOR_H
...
#include <memory>
#include <functional>
#include "joynr/tests/v2/IMultipleVersionsInterfaceConnector.h"
...
template <>
struct JoynrMessagingTraits<joynr::tests::v2::IMultipleVersionsInterfaceConnector>
{
	using Connector = joynr::tests::v2::MultipleVersionsInterfaceJoynrMessagingConnector;
};

} // namespace joynr
#endif // GENERATED_INTERFACE_JOYNR_TESTS_V2_MULTIPLEVERSIONSINTERFACEJOYNRMESSAGINGCONNECTOR_H
