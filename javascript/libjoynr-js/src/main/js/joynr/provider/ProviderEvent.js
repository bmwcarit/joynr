...
class ProviderEvent {
     ...
     * @constructor
     *
     * @param {Object} settings the settings for this provider event
     * @param {String} settings.eventName the name of the event
     * @param {Boolean} settings.selective true if the broadcast is selective
     * @param {Object} settings.outputParameterProperties the output parameter names and types
     * @param {Object} settings.filterSettings the filter settings
     */
     ...
     *
     */
    checkFilterParameters(filterParametersInput) {
     ...
     * @function
     *
     * @param {BroadcastOutputParameters} broadcastOutputParameters the broadcast output parameters
     * @param {String[]} [partitions] - the partitions to be used for multicasts
     * @throws {Error} if partitions contains invalid characters
     */
    fire(broadcastOutputParameters, partitions) {
     ...
     * @function
     *
     * @param {Function} observer the callback function with the signature "function(value){..}"
     ...
     * @function
     *
     * @param {Function} filter the callback object that executes the filtering
