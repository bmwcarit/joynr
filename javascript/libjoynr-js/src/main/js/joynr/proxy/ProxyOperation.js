 ...
 * @private
 *
 * @param {Object} operationSignature an object with the argument name as key and an object
 *            as value defining the type
 * @param {Object} operationSignature.PARAMETERNAME an object describing the single parameter
 * @param {String} operationSignature.PARAMETERNAME.type the type of the parameter
 * @param {Object} operationArguments: this object contains all parameters
 * @param {?} operationArguments.OPERATIONARGUMENTNAME: CUSTOM DOC FROM IDL GOES HERE,
 ...
 *            "argumentName2": {type: "number", value: 1234}} @throws {Error} if an argument value is nullable
 */
 ...
 * @param {DiscoveryQos} proxyOperation.settings.discoveryQos the Quality of Service parameters
 *            for arbitration
 * @param {MessagingQos} proxyOperation.settings.messagingQos the Quality of Service parameters
 *            for messaging
 *
 * @param {ProxyOperation} proxyOperation the ProxyOperation object in which context the
 *            operation is called
 * @param {Array} operationSignatures a list holding multiple versions of the signature
 *            for the overloaded operation
 * @param {Object} operationSignatures.array an object with the argument name as key and
 *            an object as value defining the type
 * @param {Object} operationSignatures.array.PARAMETERNAME an object describing the
 *            single parameter
...
class ProxyOperation {
     ...
     * @param {Array} operationSignatures.array.outputParameter an array of output parameters for
     *            one specific signature
     * @param {String} operationSignatures.array.outputParameter.name the name of the output parameter
     * @param {String} operationSignatures.array.outputParameter.type the type of the output parameter
     */
    constructor(parent, settings, operationName, operationSignatures) {
