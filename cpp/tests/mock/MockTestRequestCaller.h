...
public:
    ...
    void invokeGetterOnErrorFunctionWithProviderRuntimeException(
            ...
            std::function<void(const std::shared_ptr<joynr::exceptions::ProviderRuntimeException>&)>
                    onError)
    {
        onError(std::make_shared<joynr::exceptions::ProviderRuntimeException>(
                _providerRuntimeExceptionTestMsg));
    }

    void invokeMethodOnErrorFunctionWithProviderRuntimeException(
    ...
    void invokeMapParametersOnSuccessFct(
    ...
    {
        ON_CALL(*this, getLocationMock(_, _))
                .WillByDefault(
                        testing::Invoke(this, &MockTestRequestCaller::invokeLocationOnSuccessFct));
        ON_CALL(*this, getListOfStringsMock(_, _))
                .WillByDefault(testing::Invoke(
                        this, &MockTestRequestCaller::invokeListOfStringsOnSuccessFct));
        ON_CALL(*this, getAttributeWithProviderRuntimeExceptionMock(_, _))
                .WillByDefault(testing::Invoke(
                        this,
                        &MockTestRequestCaller::
                                invokeGetterOnErrorFunctionWithProviderRuntimeException));
        ON_CALL(*this, methodWithProviderRuntimeExceptionMock(_, _))
                .WillByDefault(testing::Invoke(
                        this,
                        &MockTestRequestCaller::
                                invokeMethodOnErrorFunctionWithProviderRuntimeException));
        ON_CALL(*this, mapParametersMock(_, _, _))
                .WillByDefault(testing::Invoke(
                        this, &MockTestRequestCaller::invokeMapParametersOnSuccessFct));
    }
    MockTestRequestCaller(testing::Cardinality getLocationCardinality)
            : joynr::tests::testRequestCaller(std::make_shared<MockTestProvider>()),
              _providerVersion(47, 11)
    {
        EXPECT_CALL(*this, getLocationMock(_, _))
                .Times(getLocationCardinality)
                .WillRepeatedly(
                        testing::Invoke(this, &MockTestRequestCaller::invokeLocationOnSuccessFct));
        EXPECT_CALL(*this, getListOfStringsMock(_, _))
    ...
    MOCK_METHOD2(
            ...
            void(std::function<void(const joynr::types::Localisation::GpsLocation& location)>,
                 std::function<void(
                         const std::shared_ptr<joynr::exceptions::ProviderRuntimeException>&)>));
    ...
    MOCK_METHOD2(registerAttributeListener,
                 void(const std::string& attributeName,
                      std::shared_ptr<joynr::SubscriptionAttributeListener> attributeListener));
    MOCK_METHOD2(registerBroadcastListener,
                 void(const std::string& broadcastName,
                      std::shared_ptr<joynr::UnicastBroadcastListener> broadcastListener));
    MOCK_METHOD2(unregisterAttributeListener,
                 void(const std::string& attributeName,
                      std::shared_ptr<joynr::SubscriptionAttributeListener> attributeListener));
    MOCK_METHOD2(unregisterBroadcastListener,
                 void(const std::string& broadcastName,
                      std::shared_ptr<joynr::UnicastBroadcastListener> broadcastListener));
