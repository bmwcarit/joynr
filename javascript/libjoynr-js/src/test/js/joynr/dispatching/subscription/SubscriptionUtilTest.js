...
describe(
        ...
        function() {
            ...
            var log =
                    LoggerFactory.getLogger("joynr.dispatching.subscription.TestSubscriptionUtil");
            ...
            it(
                    "serialize multiple subscription shall work",
                    function() {
                        var info1 =
            ...
            it(
                    "deserialize single subscription shall work",
                    function() {
                        var info =
                                createSubscriptionInformation(
                                        proxyId,
                        ...
                        var subscriptions =
                                SubscriptionUtil.deserializeSubscriptions(serializedSubscription);
            ...
            it(
                    "deserialize multiple subscriptions shall work",
                    function() {
                        var info1 =
                                createSubscriptionInformation(
                                        proxyId,
                            ...
                            if (subscriptions.hasOwnProperty(subscriptionId)) {
                                expect(
                                        subscriptionId === info1.subscriptionId
                                            || subscriptionId === info2.subscriptionId).toBe(true);
                            }
                        }
            ...
            it(
                    ...
                    function() {
                        ...
                        expect(newSubscriptions[origin.subscriptionId].subscriptionId).toBe(
                                origin.subscriptionId);
                        expect(newSubscriptions[origin.subscriptionId].subscribedToName).toBe(
                                origin.subscribedToName);
                        expect(newSubscriptions[origin.subscriptionId].proxyParticipantId).toBe(
                                origin.proxyParticipantId);
                        expect(newSubscriptions[origin.subscriptionId].providerParticipantId).toBe(
                                origin.providerParticipantId);
                        expect(newSubscriptions[origin.subscriptionId].qos.minIntervalMs).toBe(
                                origin.qos.minIntervalMs);
                        expect(newSubscriptions[origin.subscriptionId].qos.maxIntervalMs).toBe(
                                origin.qos.maxIntervalMs);
            ...
            it(
                    ...
                    function() {
                        ...
                        expect(newSubscriptions[origin1.subscriptionId].subscriptionId).toBe(
                                origin1.subscriptionId);
                        expect(newSubscriptions[origin1.subscriptionId].subscribedToName).toBe(
                                origin1.subscribedToName);
                        expect(newSubscriptions[origin1.subscriptionId].proxyParticipantId).toBe(
                                origin1.proxyParticipantId);
                        expect(newSubscriptions[origin1.subscriptionId].providerParticipantId)
                                .toBe(origin1.providerParticipantId);
                        expect(newSubscriptions[origin1.subscriptionId].qos.minIntervalMs).toBe(
                                origin1.qos.minIntervalMs);
                        expect(newSubscriptions[origin1.subscriptionId].qos.maxIntervalMs).toBe(
                                origin1.qos.maxIntervalMs);

                        expect(newSubscriptions[origin2.subscriptionId].subscriptionId).toBe(
                                origin2.subscriptionId);
                        expect(newSubscriptions[origin2.subscriptionId].subscribedToName).toBe(
                                origin2.subscribedToName);
                        expect(newSubscriptions[origin2.subscriptionId].proxyParticipantId).toBe(
                                origin2.proxyParticipantId);
                        expect(newSubscriptions[origin2.subscriptionId].providerParticipantId)
                                .toBe(origin2.providerParticipantId);
                        expect(newSubscriptions[origin2.subscriptionId].qos.minIntervalMs).toBe(
                                origin2.qos.minIntervalMs);
                        expect(newSubscriptions[origin2.subscriptionId].qos.maxIntervalMs).toBe(
                                origin2.qos.maxIntervalMs);
