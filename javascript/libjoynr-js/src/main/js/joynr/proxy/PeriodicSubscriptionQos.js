...
class PeriodicSubscriptionQos {
     ...
     * @param {Number} [settings.periodMs=PeriodicSubscriptionQos.DEFAULT_PERIOD_MS] defines
     ...
     * @param {Number} [settings.alertAfterIntervalMs=PeriodicSubscriptionQos.DEFAULT_ALERT_AFTER_INTERVAL_MS] defines how long to wait for an
     ...
     *            </ul>
     * @param {Number} [settings.publicationTtlMs] Time to live for publication messages
     *
