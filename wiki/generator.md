        ...
        <execution>
            ...
            <configuration>
                ...
                <!-- specify how the major version of Franca interfaces and typecollections shall
                    ...
                    default value: "none"
                    Generally, it's best to set the #noVersionGeneration comment and use "comment"
                        for this setting.
                    NOTE:
                ...
                <addVersionTo>package|none|comment</addVersionTo>
                <parameter>
...
* `addVersionTo` / DEPRECATED. The addVersionTo option will be removed in a future version of the
  generator. Its functionality will be replaced by the #noVersionGeneration comment in the .fidl
...
Franca file) are added as an additional package/namespace segment (temporarily disabled, at the
moment, no version information is generated by default. You can enable the new behavior by setting
the 'addVersionTo' option to 'comment'.).  
...
used again. It will be removed very soon. Use `addVersionTo = comment` to enable evaluation of the
#noVersionGeneration comment.
