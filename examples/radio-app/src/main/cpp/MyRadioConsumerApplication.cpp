...
class RadioStationListener : public ISubscriptionListener<vehicle::RadioStation>
{
public:
    ...
    void receive(vehicle::RadioStation value)
    {
...
// A class that listens to messages generated by subscriptions
class WeakSignalBroadcastListener : public ISubscriptionListener<vehicle::RadioStation>
{
public:
    ...
    void publicationMissed()
    {
        // should not be called on a broadcast subscription
    }
...
class NewStationDiscoveredBroadcastListener
        : public ISubscriptionListener<vehicle::RadioStation, vehicle::GeoPosition>
{
public:
    ...
    void receive(vehicle::RadioStation discoveredStation, vehicle::GeoPosition geoPosition)
    {
