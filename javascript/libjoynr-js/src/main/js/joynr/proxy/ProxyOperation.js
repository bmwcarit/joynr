...
define("joynr/proxy/ProxyOperation", [
    "global/Promise",
    "joynr/util/UtilInternal",
    "joynr/util/Typing",
    "joynr/dispatching/types/Request",
    "joynr/messaging/MessagingQos"
], function(Promise, Util, Typing, Request, MessagingQos) {
    ...
    function checkSignatureMatch(operationSignature, operationArguments) {
        ...
        for (argumentId in inputParameter) {
            if (inputParameter.hasOwnProperty(argumentId)) {
                ...
                var objectType = argumentValue._typeName || Typing.getObjectType(argumentValue);
                /*jslint nomen: false */
                if (Typing.translateJoynrTypeToJavascriptType(operationParameter) !== objectType) {
                    ...
                    result.errorMessage =
                            "Signature does not match: type \""
                                ...
                                + Typing.translateJoynrTypeToJavascriptType(operationParameter)
                                + "\"";
                    return result;
                }
                ...
                paramDatatypes.push(operationParameter);
        ...
        function operationFunction(operationArguments, proxyOperation, operationSignatures) {
            ...
            try {
                ...
                var request = new Request({
                    ...
                    paramDatatypes : foundValidOperationSignature.paramDatatypes,
                    params : foundValidOperationSignature.params
                });
