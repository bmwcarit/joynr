...
#include "joynr/tests/MultipleVersionsInterface2JoynrMessagingConnector.h"
...
MultipleVersionsInterface2JoynrMessagingConnector::MultipleVersionsInterface2JoynrMessagingConnector(
...
void MultipleVersionsInterface2JoynrMessagingConnector::getUInt8Attribute1(std::uint8_t& uInt8Attribute1, boost::optional<joynr::MessagingQos> qos)
{
	auto future = getUInt8Attribute1Async(nullptr, nullptr, std::move(qos));
	future->get(uInt8Attribute1);
}

std::shared_ptr<joynr::Future<std::uint8_t> > MultipleVersionsInterface2JoynrMessagingConnector::getUInt8Attribute1Async(
...
std::shared_ptr<joynr::Future<void> > MultipleVersionsInterface2JoynrMessagingConnector::setUInt8Attribute1Async(
...
void MultipleVersionsInterface2JoynrMessagingConnector::setUInt8Attribute1(const std::uint8_t& uInt8Attribute1, boost::optional<joynr::MessagingQos> qos)
{
	auto future = setUInt8Attribute1Async(uInt8Attribute1, nullptr, nullptr, std::move(qos));
	future->get();
}

std::shared_ptr<joynr::Future<std::string>> MultipleVersionsInterface2JoynrMessagingConnector::subscribeToUInt8Attribute1(
...
void MultipleVersionsInterface2JoynrMessagingConnector::unsubscribeFromUInt8Attribute1(const std::string& subscriptionId)
 {
...
void MultipleVersionsInterface2JoynrMessagingConnector::getUInt8Attribute2(std::uint8_t& uInt8Attribute2, boost::optional<joynr::MessagingQos> qos)
{
	auto future = getUInt8Attribute2Async(nullptr, nullptr, std::move(qos));
	future->get(uInt8Attribute2);
}

std::shared_ptr<joynr::Future<std::uint8_t> > MultipleVersionsInterface2JoynrMessagingConnector::getUInt8Attribute2Async(
...
std::shared_ptr<joynr::Future<void> > MultipleVersionsInterface2JoynrMessagingConnector::setUInt8Attribute2Async(
...
void MultipleVersionsInterface2JoynrMessagingConnector::setUInt8Attribute2(const std::uint8_t& uInt8Attribute2, boost::optional<joynr::MessagingQos> qos)
{
	auto future = setUInt8Attribute2Async(uInt8Attribute2, nullptr, nullptr, std::move(qos));
	future->get();
}

std::shared_ptr<joynr::Future<std::string>> MultipleVersionsInterface2JoynrMessagingConnector::subscribeToUInt8Attribute2(
			std::shared_ptr<joynr::ISubscriptionListener<std::uint8_t> > subscriptionListener,
			std::shared_ptr<joynr::SubscriptionQos> subscriptionQos)
 {
	joynr::SubscriptionRequest subscriptionRequest;
...
void MultipleVersionsInterface2JoynrMessagingConnector::unsubscribeFromUInt8Attribute2(const std::string& subscriptionId)
 {
	joynr::SubscriptionStop subscriptionStop;
	subscriptionStop.setSubscriptionId(subscriptionId);
...
void MultipleVersionsInterface2JoynrMessagingConnector::getTrue(
			bool& result,
			boost::optional<joynr::MessagingQos> qos
)
{
...
std::shared_ptr<joynr::Future<bool>> MultipleVersionsInterface2JoynrMessagingConnector:: getTrueAsync(
...
void MultipleVersionsInterface2JoynrMessagingConnector::getVersionedStruct(
...
std::shared_ptr<joynr::Future<joynr::tests::MultipleVersionsTypeCollection::VersionedStruct2>> MultipleVersionsInterface2JoynrMessagingConnector:: getVersionedStructAsync(
			const joynr::tests::MultipleVersionsTypeCollection::VersionedStruct2& input,
...
) noexcept
{
	...
	request.setParamDatatypes({
		"joynr.tests.MultipleVersionsTypeCollection.VersionedStruct2"
		});
	request.setParams(
		input
	);
	...
	std::function<void(const joynr::tests::MultipleVersionsTypeCollection::VersionedStruct2& result)> onSuccessWrapper = [
			future,
			onSuccess = std::move(onSuccess),
			requestReplyId = request.getRequestReplyId(),
			methodName = request.getMethodName()
	...
	try {
		...
		auto replyCaller = std::make_shared<joynr::ReplyCaller<joynr::tests::MultipleVersionsTypeCollection::VersionedStruct2>>(std::move(onSuccessWrapper), std::move(onErrorWrapper));
		operationRequest(std::move(replyCaller), std::move(request), std::move(qos));
	} catch (const std::invalid_argument& exception) {
		auto joynrException = std::make_shared<joynr::exceptions::MethodInvocationException>(exception.what());
		future->onError(joynrException);
...
void MultipleVersionsInterface2JoynrMessagingConnector::getAnonymousVersionedStruct(
...
std::shared_ptr<joynr::Future<joynr::tests::AnonymousVersionedStruct2>> MultipleVersionsInterface2JoynrMessagingConnector:: getAnonymousVersionedStructAsync(
			const joynr::tests::AnonymousVersionedStruct2& input,
...
) noexcept
{
	...
	request.setParamDatatypes({
		"joynr.tests.AnonymousVersionedStruct2"
		});
	request.setParams(
		input
	);
	...
	std::function<void(const joynr::tests::AnonymousVersionedStruct2& result)> onSuccessWrapper = [
			future,
			onSuccess = std::move(onSuccess),
			requestReplyId = request.getRequestReplyId(),
			methodName = request.getMethodName()
	...
	try {
		...
		auto replyCaller = std::make_shared<joynr::ReplyCaller<joynr::tests::AnonymousVersionedStruct2>>(std::move(onSuccessWrapper), std::move(onErrorWrapper));
		operationRequest(std::move(replyCaller), std::move(request), std::move(qos));
	} catch (const std::invalid_argument& exception) {
		auto joynrException = std::make_shared<joynr::exceptions::MethodInvocationException>(exception.what());
		future->onError(joynrException);
...
void MultipleVersionsInterface2JoynrMessagingConnector::getInterfaceVersionedStruct(
...
std::shared_ptr<joynr::Future<joynr::tests::InterfaceVersionedStruct2>> MultipleVersionsInterface2JoynrMessagingConnector:: getInterfaceVersionedStructAsync(
			const joynr::tests::InterfaceVersionedStruct2& input,
...
) noexcept
{
	...
	request.setParamDatatypes({
		"joynr.tests.InterfaceVersionedStruct2"
		});
	request.setParams(
		input
	);
	...
	std::function<void(const joynr::tests::InterfaceVersionedStruct2& result)> onSuccessWrapper = [
			future,
			onSuccess = std::move(onSuccess),
			requestReplyId = request.getRequestReplyId(),
			methodName = request.getMethodName()
	...
	try {
		...
		auto replyCaller = std::make_shared<joynr::ReplyCaller<joynr::tests::InterfaceVersionedStruct2>>(std::move(onSuccessWrapper), std::move(onErrorWrapper));
		operationRequest(std::move(replyCaller), std::move(request), std::move(qos));
	} catch (const std::invalid_argument& exception) {
		auto joynrException = std::make_shared<joynr::exceptions::MethodInvocationException>(exception.what());
		future->onError(joynrException);
