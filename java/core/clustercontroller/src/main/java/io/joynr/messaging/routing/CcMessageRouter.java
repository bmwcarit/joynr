...
public class CcMessageRouter extends AbstractMessageRouter {
    ...
    protected ImmutableMessage createReplyMessageWithError(ImmutableMessage requestMessage,
        ...
        try {
            ...
            replyMessage.setType(Message.VALUE_MESSAGE_TYPE_REPLY);
            ...
            logger.error("Failed to prepare ReplyMessageWithError for msgId: {}. from: {} to: {}. Reason: {}. Discarding joynr message.",
