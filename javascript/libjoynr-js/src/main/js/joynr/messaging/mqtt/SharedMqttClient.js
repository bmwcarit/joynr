        ...
        function(Promise, Mqtt, JoynrMessage, MessagingQosEffort, JSONSerializer, LongTimer, Typing, LoggerFactory) {
            ...
            var SharedMqttClient =
                function SharedMqttClient(settings) {
                    ...
                    var closed = false;
                    var connected = false;
                    var onConnectedPromise = new Promise(function(resolveTrigger) { // TODO: refactor this
                    ...
                    onOpen = function onOpen() {
                        try {
                            ...
                            sendQueuedSubscriptions(client, queuedSubscriptions, qosLevel).then(resolve); // TODO uncatched promise
                        } catch (e) {
                            resetConnection();
                        }
                    };
                    ...
                    this.send = function send(topic, joynrMessage) {
                        ...
                        return sendMessage(client, topic, joynrMessage, sendQosLevel, queuedMessages).catch(resetConnection);
                    };
