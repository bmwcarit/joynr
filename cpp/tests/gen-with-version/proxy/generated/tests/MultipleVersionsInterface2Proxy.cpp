...
MultipleVersionsInterface2Proxy::MultipleVersionsInterface2Proxy(
		...
		MultipleVersionsInterface2SyncProxy(runtime, connectorFactory, domain, qosSettings),
		MultipleVersionsInterface2AsyncProxy(runtime, connectorFactory, domain, qosSettings)
{
}
