...
@ProvidesJoynrTypesInfo(interfaceClass = PingService.class, interfaceName = "io/joynr/sharedsubscriptions/test/PingService")
@SuppressWarnings("unused")
public interface PingService {
	public static String INTERFACE_NAME = "io/joynr/sharedsubscriptions/test/PingService";
