 ...
 * #L%
 */
var EnumInsideTypeCollectionWithoutVersion =
        require('../../../test-classes/joynr/types/TestTypesWithoutVersion/EnumInsideTypeCollectionWithoutVersion');
var MapInsideTypeCollectionWithoutVersion =
...
var Typing = require('../../../classes/joynr/util/Typing');
            ...
            describe(
                    "libjoynr-js.joynr.TypeGenerator.Compound",
                    function() {
                        ...
                        it("type collection struct default version is set correctly", function() {
                            expect(StructInsideTypeCollectionWithoutVersion.MAJOR_VERSION)
                                    .toBeDefined();
                            expect(StructInsideTypeCollectionWithoutVersion.MAJOR_VERSION).toEqual(
                                    0);
                            expect(StructInsideTypeCollectionWithoutVersion.MINOR_VERSION)
                                    .toBeDefined();
                            expect(StructInsideTypeCollectionWithoutVersion.MINOR_VERSION).toEqual(
                                    0);
                        });
                        ...
                        it(
                                "StructWithTypedefMembers: checkMembers accepts correct types",
                                function() {
                                    expect(TStructWithTypedefMembers.checkMembers.bind(
                                            this,
                                            testStructWithTypeDefMembers,
                                            Typing.checkPropertyIfDefined)).not.toThrow();
                                });

                        it(
                                "StructWithTypedefMembers: checkMembers detects wrong types",
                                function() {
                                    var testStruct;

                                    testStruct =
                                            new TStructWithTypedefMembers(
                                                    testStructWithTypeDefMembers);
                                    ...
                                    expect(
                                            ...
                                            .toThrowError(
                                                    Error,
                                                    "members.typeDefForTStruct is not of a type from Object,TStruct. Actual type is String");
                                    ...
                                    testStruct =
                                            new TStructWithTypedefMembers(
                                                    testStructWithTypeDefMembers);
                                    testStruct.arrayOfTypeDefForPrimitive =
                                            testStruct.typeDefForPrimitive;
                                    expect(
                                            TStructWithTypedefMembers.checkMembers.bind(
                                                    this,
                                                    testStruct,
                                    ...
                                    testStruct =
                                            new TStructWithTypedefMembers(
                                                    testStructWithTypeDefMembers);
                                    testStruct.arrayOfTypeDefForTStruct =
                                            testStruct.typeDefForTStruct;
                                    expect(
                                            TStructWithTypedefMembers.checkMembers.bind(
                                                    this,
                                                    testStruct,
                                    ...
                                    testStruct =
                                            new TStructWithTypedefMembers(
                                                    testStructWithTypeDefMembers);
                                    testStruct.arrayOfTypeDefForTStringKeyMap =
                                            testStruct.typeDefForTStringKeyMap;
                                    expect(
                                            TStructWithTypedefMembers.checkMembers.bind(
                                                    this,
                                                    testStruct,
