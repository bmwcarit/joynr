...
class MessageRouter {
     ...
     * @name MessageRouter
     *
     * @param {Object} settings the settings object holding dependencies
     * @param {RoutingTable} settings.routingTable
     * @param {MessagingStubFactory} settings.messagingStubFactory
     * @param {String} settings.myChannelId
    ...
    constructor(settings) {
         ...
         * @returns {Promise} promise
         */
        this.addNextHopToParentRoutingTable = function addNextHopToParentRoutingTable(
            participantId,
            isGloballyVisible
        ) {
        ...
        function resolveNextHopAndRoute(participantId, joynrMessage) {
            ...
            if (address === undefined) {
                ...
                if (
                    ...
                    const errorMsg = `Received message for unknown proxy. Dropping the message. ID: ${
                        joynrMessage.msgId
                    }`;
                    const now = Date.now();
        ...
        this.route = function route(joynrMessage) {
            try {
                ...
                if (joynrMessage.type === JoynrMessage.JOYNRMESSAGE_TYPE_MULTICAST) {
                    return Promise.all(
                        getAddressesForMulticast(joynrMessage).map(forwardToRouteInternal, joynrMessage)
                    );
                }
         ...
         *
         * @param {String} participantId
         * @param {Address} address the address to register
         * @param {boolean} isGloballyVisible
         * @returns {Object} A+ promise object
         */
         ...
         * @param {String} parameters.multicastId
         * @param {String} parameters.subscriberParticipantId
         * @param {String} parameters.providerParticipantId
         * @returns {Object} A+ promise object
         */
