...
class RadioStationListener : public SubscriptionListener<vehicle::RadioTypes::StdRadioStation>
{
public:
    ...
    void onReceive(const vehicle::RadioTypes::StdRadioStation& value)
    {
...
// A class that listens to messages generated by subscriptions
class WeakSignalBroadcastListener
        : public SubscriptionListener<vehicle::RadioTypes::StdRadioStation>
{
public:
...
public:
    ...
    void onReceive(const vehicle::RadioTypes::StdRadioStation& discoveredStation,
                   const vehicle::RadioTypes::StdGeoPosition& geoPosition)
    {
        MyRadioHelper::prettyLog(logger,
...
int main(int argc, char* argv[])
{
    ...
    vehicle::RadioTypes::StdRadioStation currentStation;
    ...
    vehicle::RadioTypes::StdRadioStation favouriteStation(
            "99.3 The Fox Rocks", false, vehicle::RadioTypes::StdCountry::CANADA);
    bool success;
    ...
    while ((key = MyRadioHelper::getch()) != 'q') {
        joynr::vehicle::RadioTypes::StdGeoPosition location;
        joynr::vehicle::RadioTypes::StdCountry::Enum country;
        switch (key) {
        case 's':
            proxy->shuffleStations(status);
            break;
            ...
            MyRadioHelper::prettyLog(
                    ...
                    QString("METHOD: getLocationOfCurrentStation: country: %1, location: %2")
                            .arg(QString::fromStdString(
                                    joynr::vehicle::RadioTypes::StdCountry::getLiteral(country)))
