...
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1JOYNRMESSAGINGCONNECTOR_H
#define GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1JOYNRMESSAGINGCONNECTOR_H
...
/** @brief JoynrMessagingConnector for interface MultipleVersionsInterface1 */
class  MultipleVersionsInterface1JoynrMessagingConnector : public IMultipleVersionsInterface1Connector, virtual public joynr::AbstractJoynrMessagingConnector {
private:
	/**
...
public:
	 ...
	 */
	MultipleVersionsInterface1JoynrMessagingConnector(
	...
	/** @brief Destructor */
	~MultipleVersionsInterface1JoynrMessagingConnector() override = default;
...
// this links IMultipleVersionsInterface1Connector with MultipleVersionsInterface1JoynrMessagingConnector
template <>
struct JoynrMessagingTraits<joynr::tests::IMultipleVersionsInterface1Connector>
{
	using Connector = joynr::tests::MultipleVersionsInterface1JoynrMessagingConnector;
};

} // namespace joynr
#endif // GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1JOYNRMESSAGINGCONNECTOR_H
