...
MethodInvocationException::MethodInvocationException() noexcept
        : JoynrRuntimeException(), _providerVersion()
{
}

MethodInvocationException::MethodInvocationException(const std::string& message) noexcept
        : JoynrRuntimeException(message), _providerVersion()
{
}
...
MethodInvocationException::MethodInvocationException(
        ...
        : JoynrRuntimeException(message), _providerVersion(providerVersion)
{
}
