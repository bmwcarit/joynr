...
const asWrite = (function() {
    /**
         ...
         *
         * @param {Object} settings - the settings object for this function call
         * @param {Object} settings.value - the attribute value to set
...
const asNotify = (function() {
    /**
         ...
         *
         * @param {Object} settings the settings object for this function call
         * @param {SubscriptionQos} settings.subscriptionQos - the subscription quality of service object
         * @param {MessagingQos} settings.messagingQos - The messagingQos to use for this subscriptionRequest.
         *
         * @param {Function} settings.onReceive this function is called if the attribute has
         *            been published successfully, method signature:
         *            "void onReceive({?}value)"
         * @param {Function} settings.onError - this function is called if a publication of the attribute value was
         *          missed, method signature: "void onError({Error} error)"
         * @param {Function} settings.onSubscribed - the callback to inform once the subscription request has been
         *          delivered successfully
         * @param {String} [settings.subscriptionId] - optional subscriptionId to be used for the new subscription
         * @returns {Object} returns an A+ promise object
         */
    ...
    /**
         ...
         *
         * @param {Object} settings - the settings object for this function call
         * @param {String} settings.subscriptionId - the subscription id retrieved from the
         *          subscribe function
         * @returns {Object} returns an A+ promise object
         *
...
class ProxyAttribute {
     ...
     * @param {String} attributeCaps - the capabilities of the attribute:
     ...
     */
    constructor(parent, settings, attributeName, attributeType, attributeCaps) {
        this.parent = parent;
     ...
     * @param {MessagingQos} requestSettings.messagingQos
     * @returns {Object} an A+ promise
     */
    executeRequest(request, requestSettings) {
        // passed in (right-most) messagingQos have precedence; undefined values are
        // ignored
