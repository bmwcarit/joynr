...
describe("libjoynr-js.integration.end2end.datatypes", () => {
    ...
    it("supports all datatypes in attributes get/set", done => {
        let i, j;
    ...
    it("supports all datatypes as operation arguments", done => {
        let i;
    ...
    it("supports all datatypes as operation argument and return value", done => {
        let i;
    ...
    it("supports multiple operation arguments", done => {
        let i;
