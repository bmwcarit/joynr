...
define([
    ...
    describe("libjoynr-js.joynr.CapabilitiesUtil.discoveryEntryConversions", function() {
        ...
        it("convert to local DiscoveryEntryWithMetaInfo", function() {
            ...
            convertedDiscoveryEntry =
                    CapabilitiesUtil
                            .convertToDiscoveryEntryWithMetaInfo(true, globalDiscoveryEntry);
            compareDiscoveryEntriesWithMetaInfo(
                    true,
                    localDiscoveryEntryWithMetaInfo,
                    convertedDiscoveryEntry);
        ...
        it(
                "convert to array of local DiscoveryEntryWithMetaInfo",
                function() {
                    ...
                    compareArrayOfDiscoveryEntriesWithMetaInfo(
                            true,
                            expected,
                            convertedDiscoveryEntryArray);
                });
