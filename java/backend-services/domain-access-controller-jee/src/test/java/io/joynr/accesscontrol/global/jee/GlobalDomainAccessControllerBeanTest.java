...
public class GlobalDomainAccessControllerBeanTest {
    ...
    private final static String[] DOMAINS = { "domain1" };
    ...
    public void testCreate() {
        ...
        verify(globalDomainAccessControllerSubscriptionPublisherMock).fireDomainRoleEntryChanged(eq(ChangeType.ADD), eq(domainRoleEntry), eq(
            USER_PARTITION));
    }
    ...
    public void testUpdate() {
        ...
        verify(domainRoleEntryManagerMock).createOrUpdate(eq(domainRoleEntry));
        verify(globalDomainAccessControllerSubscriptionPublisherMock).fireDomainRoleEntryChanged(eq(ChangeType.UPDATE), eq(domainRoleEntry),
            eq(USER_PARTITION));
    }
