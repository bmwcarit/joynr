...
class MockJoynrClusterControllerMqttConnectionData : public joynr::JoynrClusterControllerMqttConnectionData
{
public:
    ...
    MOCK_METHOD1(setMqttMessageReceiver, void(const std::shared_ptr<ITransportMessageReceiver>& value));
