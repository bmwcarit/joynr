...
//#######################################################
// #####################################################
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1PROVIDER_H
#define GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1PROVIDER_H
...
/**
 * @brief Provider class for interface MultipleVersionsInterface1
 *
 * @version 1.0
 */
class  MultipleVersionsInterface1Provider : public virtual IJoynrProvider
{

public:
	/** @brief Default constructor */
	MultipleVersionsInterface1Provider();
	...
	/** @brief Destructor */
	~MultipleVersionsInterface1Provider() override;
...
private:
	DISALLOW_COPY_AND_ASSIGN(MultipleVersionsInterface1Provider);
};
...
// this links MultipleVersionsInterface1Provider with MultipleVersionsInterface1RequestCaller
template <>
struct RequestCallerTraits<joynr::tests::MultipleVersionsInterface1Provider>
{
	using RequestCaller = joynr::tests::MultipleVersionsInterface1RequestCaller;
};

} // namespace joynr

#endif // GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACE1PROVIDER_H
