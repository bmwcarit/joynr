 ...
 * @private
 *
 * @param {DiscoveryEntry} discoveryEntry - discovery entry
 */
...
class CapabilitiesStore {
     ...
     *
     * @param {GlobalDiscoveryEntry[]} initialCapabilities
     */
     ...
     * @function
     *
     * @param {String} participantId - the participant ID uniquely identifying the discovery entry to be removed
     */
    _removeDiscoveryEntryFromStore(participantId) {
     ...
     * @function
     *
     * @param {DiscoveryEntry} discoveryEntry - the capability to register
     *
     */
    _addDiscoveryEntryToStore(discoveryEntry) {
     ...
     * @function
     *
     * @param {Object} settings - an object containing the required parameters
     * @param {Array.<DiscoveryEntry>} settings.discoveryEntries - an array of discovery entries to register
     * @param {DiscoveryEntry} settings.discoveryEntry a single discovery entry to register (only if settings.discoveryEntries is not supplied)
     * @param {Boolean} settings.remote true if the provided entry/entries are gathered from remote
     *
     ...
     */
    _checkAge(discoveryEntry, maxAge) {
     ...
     */
    _qosMatches(discoveryEntry, cacheMaxAge) {
     ...
     */
    _filterEntries(entries, cacheMaxAge) {
        const returnValue = [];
     ...
     *
     * @param {Object} settings - an object containing the required parameters
     * @param {String} settings.domains - the name of the domains
     * @param {String} settings.interfaceName - the interface name of the capability
     * @param {String} settings.participantId - the participantId of the capability
     * @param {DiscoveryQos} settings.cacheMaxAge - max age used for filtering the store entries
     *
     ...
     *
     * @param {Object} settings - an object containing the required parameters
     * @param {Array.<String>} settings.participantIds - an array of participant IDs uniquely identifying the discovery entry to be removed
     * @param {String} settings.participantId -  a participant ID uniquely identifying the discovery entry to be removed
     *
     * @returns {CapabilitiesStore} returns this for a fluent interface
     */
    remove(settings) {
