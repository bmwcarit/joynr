...
class RadioStationListener : public SubscriptionListener<vehicle::RadioTypes::RadioStation>
{
public:
    ...
    void onReceive(const vehicle::RadioTypes::RadioStation& value)
    {
...
// A class that listens to messages generated by subscriptions
class WeakSignalBroadcastListener : public SubscriptionListener<vehicle::RadioTypes::RadioStation>
{
public:
...
class NewStationDiscoveredBroadcastListener
        : public SubscriptionListener<vehicle::RadioTypes::RadioStation,
                                      vehicle::RadioTypes::GeoPosition>
{
public:
    ...
    void onReceive(const vehicle::RadioTypes::RadioStation& discoveredStation,
                   const vehicle::RadioTypes::GeoPosition& geoPosition)
    {
        MyRadioHelper::prettyLog(logger,
...
int main(int argc, char* argv[])
{
    ...
    std::shared_ptr<ISubscriptionListener<vehicle::RadioTypes::RadioStation>> listener(
    ...
    std::shared_ptr<ISubscriptionListener<vehicle::RadioTypes::RadioStation>>
    ...
    while ((key = MyRadioHelper::getch()) != 'q') {
        joynr::vehicle::RadioTypes::GeoPosition location;
            ...
            MyRadioHelper::prettyLog(
                    ...
                    QString("METHOD: getLocationOfCurrentStation: country: %1, location: %2")
                            .arg(QString::fromStdString(
                                    joynr::vehicle::RadioTypes::Country::getLiteral(country)))
