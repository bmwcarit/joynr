        ...
        describe("libjoynr-js.integration.end2end.subscription", function() {
            ...
            function expectPublicationError(spy) {
                return waitsFor(
                    ...
                    expect(spy.onError.calls.argsFor(0)[0]._typeName).toEqual(
                ...
                radioProxy.numberOfStations
                    ...
                    .catch(function(error) {
                        return IntegrationUtils.outputPromiseError(
                            new Error(
                                "End2EndSubscriptionTest.checkUnsubscribe. Error while subscribing: " + error.message
                            )
                        );
                    });
                    ...
                    .then(function() {
                        ...
                        radioProxy.numberOfStations
                            ...
                            .catch(function(error) {
                                return IntegrationUtils.outputPromiseError(
                                    new Error(
                                        "End2EndSubscriptionTest.checkUnsubscribe. Error while unsubscribing: " +
                                            error.message
                                    )
                                );
                            });
                ...
                setupSubscriptionAndReturnSpy("weakSignal", subscriptionQosOnChange)
                    ...
                    .then(function() {
                        return expectPublication(mySpy, function(call) {
                            ...
                            expect(call.args[0].byteBuffer).toEqual([
                                0,
                                1,
                                2,
                                3,
            ...
            describe("multicasts with partitions", function() {
                ...
                it("subscribe to the same non-selective broadcast with different partitions", function(done) {
                    ...
                    return setupMulticastSubscriptionWithPartitionAndReturnSpy(partitions0)
                        .then(function(spy0) {
                            return setupMulticastSubscriptionWithPartitionAndReturnSpy(partitions1).then(function(
                                spy1
                            ) {
                                return [spy0, spy1];
                            });
                        ...
                        .then(function() {
                            return expectMultiplePublications(mySpy, times, 5000, function(calls) {
                                ...
                                for (i = 0; i < times; i++) {
                                    ...
                                    expect(calls.argsFor(i)[0].enumArrayOutput).toEqual([
                                        Country.GERMANY,
                                        Country.ITALY
                                    ]);
                                }
            ...
            it("publishes correct values with onChange " + nrPubs + " times", function(done) {
                ...
                radioProxy.numberOfStations
                    ...
                    .catch(function(error) {
                        return IntegrationUtils.outputPromiseError(
                            new Error(
                                "publishes correct values with onChange. Subscribe to numberOfStations: " +
                                    error.message
                            )
                        );
                    });
