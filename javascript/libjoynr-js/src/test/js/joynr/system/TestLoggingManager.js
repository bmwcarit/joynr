...
define(
        ...
        function(LoggingManager, WebWorkerMessagingAppender, LoggerFactory) {
            ...
            describe(
                    "libjoynr-js.joynr.util.LoggingManager",
                    function() {
                        ...
                        it(
                                ...
                                function() {
                                    ...
                                    expect(loggingManager.getAppender(config.name)).toEqual(
                                            appender);
                                    expect(
                        ...
                        it(
                                "adds an appender of registered type",
                                function() {
                                    var loggingManager = new LoggingManager();
                                    var config = {
                                        type : "MyAppenderType",
                                    ...
                                    expect(loggingManager.getAppender(config.name)).toEqual(
                                            appender);
                                    expect(
                                            loggingManager.getAppender(config.name) instanceof MyAppenderType)
                                            .toEqual(true);

                                });

                        it(
                                "loads loggers and appenders as defined in a config with arrays",
                                function() {
                                    var loggingManager = new LoggingManager();
                                    ...
                                    expect(
                                            ...
                                            .toEqual(true);
                                    expect(
                                            loggingManager.getAppender("WEBWORKER") instanceof WebWorkerMessagingAppender)
                                            .toEqual(true);
                                    expect(loggingManager.getLogger("TestLogger1").getLevel())
                                            .toEqual(loggingManager.getLogLevel("info"));
                                    expect(loggingManager.getLogger("TestLogger2").getLevel())
                                            .toEqual(loggingManager.getLogLevel("error"));

                                });

                        it(
                                "loads loggers and appenders as defined in a config with object keys",
                                function() {
                                    var loggingManager = new LoggingManager();
                        ...
                        it(
                                "configures loggers with multiple appenders",
                                function() {
                                    ...
                                    AppenderType1.prototype =
                                            new LoggerFactory.BrowserConsoleAppender();
                                    var AppenderType2 = function() {};
                                    AppenderType2.prototype =
                                            new LoggerFactory.BrowserConsoleAppender();
                                    ...
                                    expect(
                                            loggingManager.getAppender("APPENDER1") instanceof AppenderType1)
                                            .toEqual(true);
                                    expect(
                                            loggingManager.getAppender("APPENDER2") instanceof AppenderType2)
                                            .toEqual(true);

                                    log = LoggerFactory.getRootLogger();
                                    expect(log.getLevel()).toEqual(
                                            loggingManager.getLogLevel("debug"));
                                    log.info("test1");
