...
class InterfaceAbstractProviderAsyncTemplate implements InterfaceTemplate{
	@Inject	extension JoynrJavaGeneratorExtensions
	@Inject extension TemplateBase

	override generate(FInterface serviceInterface) {
		val interfaceName =  serviceInterface.joynrName
		val className = interfaceName + "AbstractProviderAsync"
		val providerInterfaceName = interfaceName + "ProviderAsync"
