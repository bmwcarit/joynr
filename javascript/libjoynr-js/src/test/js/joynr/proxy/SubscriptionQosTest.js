...
describe(
        ...
        function() {
            ...
            it("is of correct type", function(done) {
                ...
                expect(subscriptionQos instanceof OnChangeWithKeepAliveSubscriptionQos).toEqual(
                        true);
                done();
            });
            ...
            it(
                    ...
                    function(done) {
                        ...
                        expect(createSubscriptionQos(1, 50, false, 4, 5, 100).alertAfterIntervalMs)
                                .toEqual(50);
                        ...
                        expect(
                                createSubscriptionQos(
                                        ...
                                        100).alertAfterIntervalMs).toEqual(
                                OnChangeWithKeepAliveSubscriptionQos.MAX_ALERT_AFTER_INTERVAL_MS);
                        testValues(1, 50, false, 4, 51, 100);

                        //wrong publicationTtlMs
                        expect(testValues(-1, -2, true, -4, -5, -6).publicationTtlMs).toEqual(
                        ...
                        expect(testValues(60, 62, true, -4, -5, 200).alertAfterIntervalMs).toEqual(
                                62);
                        ...
                        //wrong expiryDateMs
                        expect(testValues(60, -2, true, -4, 100, 200).expiryDateMs).toEqual(
            ...
            it(
                    ...
                    function(done) {
                        ...
                        expect(fixture.maxIntervalMs).toEqual(
            ...
            it("constructs PeriodicSubscriptionQos with correct default values", function(done) {
                ...
                expect(fixture.alertAfterIntervalMs).toEqual(
                        OnChangeWithKeepAliveSubscriptionQos.DEFAULT_ALERT_AFTER_INTERVAL_MS);
                expect(fixture.publicationTtlMs)
                        .toEqual(SubscriptionQos.DEFAULT_PUBLICATION_TTL_MS);
                done();
            });
