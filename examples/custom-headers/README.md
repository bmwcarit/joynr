...
First we need to create a vehicle configuration entry:
	...
	$ cd custom-headers-jee-consumer
...
application, then run:
	...
	$ docker-compose up -d custom-headers-consumer ; docker-compose logs -f custom-headers-consumer
