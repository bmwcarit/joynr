...
/**
 * Qualifier annotation for a {@link Produces producer} method, which returns <code>Properties</code> to use in creating
 * the joynr runtime in the {@link JoynrRuntimeFactory}.
 * <p>
 * In order to specify your own joynr properties, create a <code>@Singleton</code> EJB which has a method annotated with
 * {@link Produces} and <code>JoynrProperties</code> and returns a <code>Properties</code> instance. These properties
