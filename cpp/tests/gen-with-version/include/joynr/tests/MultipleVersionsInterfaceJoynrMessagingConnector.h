...
#ifndef GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACEJOYNRMESSAGINGCONNECTOR_H
#define GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACEJOYNRMESSAGINGCONNECTOR_H
...
#include <memory>
#include <functional>
#include "joynr/tests/IMultipleVersionsInterfaceConnector.h"
...
template <>
struct JoynrMessagingTraits<joynr::tests::IMultipleVersionsInterfaceConnector>
{
	using Connector = joynr::tests::MultipleVersionsInterfaceJoynrMessagingConnector;
};

} // namespace joynr
#endif // GENERATED_INTERFACE_JOYNR_TESTS_MULTIPLEVERSIONSINTERFACEJOYNRMESSAGINGCONNECTOR_H
